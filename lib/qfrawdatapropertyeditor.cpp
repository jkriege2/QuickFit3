...
void QFRawDataPropertyEditor::createWidgets() {
    ...
    actRemoveFile=new QAction(QIcon(":/lib/file_delete.png"), tr("&delete file"), this);
    actRemoveFile->setEnabled(false);
    actEditFile=new QAction(QIcon(":/lib/file_edit.png"), tr("&edit file"), this);
...
void QFRawDataPropertyEditor::showStatistics()
{
...
void QFRawDataPropertyEditor::showStatisticsComparing()
{
    QFHistogramService* hs=QFHistogramService::getInstance();
    if (hs&&current) {
        QModelIndexList idxs=tvResults->selectionModel()->selectedIndexes();
