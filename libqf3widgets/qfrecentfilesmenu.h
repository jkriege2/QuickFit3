...
#ifndef QFRecentFilesMenu_H
#define QFRecentFilesMenu_H
...
/*! \brief a special QMenu that allows to manage a list of recently loaded files
    \ingroup tools_qt
 */
class QFWIDLIB_EXPORT QFRecentFilesMenu : public QMenu {
        Q_OBJECT
    public:
        explicit QFRecentFilesMenu(QWidget *parent = 0);
        ...
        void readSettings(QFManyFilesSettings& settings, QString prefix=QString(""));
