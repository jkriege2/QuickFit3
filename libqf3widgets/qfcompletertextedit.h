...
/** \brief displays a line number bar, when used together with a QTextEdit.
  ...
  * .
  */
class QFWIDLIB_EXPORT QFCompleterTextEditNumberBar : public QWidget {
        Q_OBJECT
    public:
    ...
    public:
        ...
        QFCompleterTextEditNumberBar(QTextEdit* edtr, QWidget* parent=0);

        /** \brief class destructor */
        ~QFCompleterTextEditNumberBar();
...
/** \brief a text editor class with sytax highlighting and advanced editing functionality
  ...
  * \image html editor_editor.png
  */
class QFWIDLIB_EXPORT QFCompleterTextEditWidget : public QTextEdit
{
    Q_OBJECT
    private:
    ...
    public:
        /** \brief class constructor */
        QFCompleterTextEditWidget(QWidget *parent = 0);
        /** \brief class destructor */
        ~QFCompleterTextEditWidget();
...
/** \brief this class groups a CompleterTextEditWidget and a CompleterTextEditNumberBar to a complete
  ...
  */
class QFWIDLIB_EXPORT QFCompleterTextEdit : public QWidget
{
    Q_OBJECT
    private:
        /** \brief the actual editor widget */
        QFCompleterTextEditWidget* editor;
        /** \brief the number bar widget */
        QFCompleterTextEditNumberBar* numbers;
    ...
    public:
        /** \brief class constructor */
        QFCompleterTextEdit(QWidget* parent=0);

        /** \brief returns a pointer to the editor component */
        QFCompleterTextEditWidget* getEditor() { return editor; };
