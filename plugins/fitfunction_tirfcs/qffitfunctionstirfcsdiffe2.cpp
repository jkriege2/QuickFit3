...
unsigned int QFFitFunctionsTIRFCSDiffE2::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsTIRFCSDiffE2::transformParametersForAdditionalPlot(int plot, double* params) const {
