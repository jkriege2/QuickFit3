...
class QFFitFunctionsTIRFFCCSFW2DDiffXY2ColorACFR: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("2-color TIR-FCCS: 1-comp. 2D Normal Diffusion (xy), species A+B+AB, c/D per species (rect. pixel, 1/e^2 radii), ACF red"); }
