...
QFFitFunctionsTIRFCSDiffE2Diffbright::QFFitFunctionsTIRFCSDiffE2Diffbright() {
    ...
    #define SPIMFCSADIFF_msd_tau 19
    ...
    #define SPIMFCSADIFF_msd_at_tau1 20
    ...
    #define SPIMFCSADIFF_msd_at_tau2 21
    ...
    #define SPIMFCSADIFF_msd_at_tau3 22
...
double QFFitFunctionsTIRFCSDiffE2Diffbright::evaluate(double t, const double* data) const {
...
void QFFitFunctionsTIRFCSDiffE2Diffbright::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionsTIRFCSDiffE2Diffbright::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSSDiff_n_components];
    switch(parameter) {
...
unsigned int QFFitFunctionsTIRFCSDiffE2Diffbright::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsTIRFCSDiffE2Diffbright::transformParametersForAdditionalPlot(int plot, double* params) const {
