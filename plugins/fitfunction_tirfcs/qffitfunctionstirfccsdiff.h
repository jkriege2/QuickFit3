...
#ifndef QFFitFunctionsTIRFCCSDiffE2NewVeffE2_H
#define QFFitFunctionsTIRFCCSDiffE2NewVeffE2_H
...
*/
class QFFitFunctionsTIRFCCSDiffE2: public QFFCSLargeFocusFitFunctionBase {
    public:
        QFFitFunctionsTIRFCCSDiffE2();
        virtual ~QFFitFunctionsTIRFCCSDiffE2() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("2-pixel TIR-FCCS (camera): 2D Normal Diffusion (rect. pixel, 1/e^2 radii)"); }
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return name(); }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("fccs_tir_diffe2"); }
...
#endif // QFFitFunctionsTIRFCCSDiffE2NewVeffE2_H
