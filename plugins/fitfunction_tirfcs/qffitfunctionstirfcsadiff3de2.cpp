...
QFFitFunctionsTIRFCSADiff3DE2::QFFitFunctionsTIRFCSADiff3DE2() {
    ...
    #define FCSSDiff_penetration_depth 19
    ...
    #define FCSSDiff_focus_volume 20
...
double QFFitFunctionsTIRFCSADiff3DE2::evaluate(double t, const double* data) const {
...
void QFFitFunctionsTIRFCSADiff3DE2::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionsTIRFCSADiff3DE2::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSSDiff_n_components];
    int nonfl_comp=data[FCSSDiff_n_nonfluorescent];
    switch(parameter) {
        case FCSSDiff_diff_rho1:  return comp>0;
        case FCSSDiff_diff_rho2: case FCSSDiff_diff_coeff2: case FCSDiff_diff_alpha2: case FCSDiff_msd_at_tau2: case FCSDiff_msd_time_aeff2: return comp>0;
        case FCSSDiff_diff_rho3: case FCSSDiff_diff_coeff3: case FCSDiff_diff_alpha3: case FCSDiff_msd_at_tau3: case FCSDiff_msd_time_aeff3: return comp>1;
