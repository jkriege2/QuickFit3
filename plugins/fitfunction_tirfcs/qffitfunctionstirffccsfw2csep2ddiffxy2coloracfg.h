...
#ifndef QFFitFunctionsTIRFFCCSFW2CSep2DDiffXY2ColorACFG_H
...
class QFFitFunctionsTIRFFCCSFW2CSep2DDiffXY2ColorACFG: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("2-color TIR-FCCS (camera): 2-comp. 2D Normal Diffusion (xy), species A+B+AB, c per species, D1/D2 per channel (rect. pixel, 1/e^2 radii), ACF green"); }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("fccs_tir_fw_2csep2ddiffxy2coloracfg"); }
...
#endif // QFFitFunctionsTIRFFCCSFW2CSep2DDiffXY2ColorACFG_H
