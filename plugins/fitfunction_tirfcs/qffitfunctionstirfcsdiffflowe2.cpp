...
unsigned int QFFitFunctionsTIRFCSDiffFlowE2::getAdditionalPlotCount(const double* params) {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsTIRFCSDiffFlowE2::transformParametersForAdditionalPlot(int plot, double* params) {
