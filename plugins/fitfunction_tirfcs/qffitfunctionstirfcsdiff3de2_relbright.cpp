...
QFFitFunctionsTIRFCSDiffE2Diff3Dbright::QFFitFunctionsTIRFCSDiffE2Diff3Dbright() {
    ...
    #define FCSSDiff_focus_width 17
...
double QFFitFunctionsTIRFCSDiffE2Diff3Dbright::evaluate(double t, const double* data) const {
