...
#include "qffitfunctionstirfcsdiff3dpixele2.h"
#include <cmath>
#include "qftools.h"
...
QFFitFunctionsTIRFCSDiff3DPixelE2::QFFitFunctionsTIRFCSDiff3DPixelE2() {
    ...
    #define FCSSDiff_penetration_depth 12
    ...
    #define FCSADiff_focus_volume 13
    ...
    #define SPIMFCSADIFF_msd_tau 18
    ...
    #define SPIMFCSADIFF_msd_at_tau1 19
    ...
    #define SPIMFCSADIFF_msd_at_tau2 20
    ...
    #define SPIMFCSADIFF_msd_at_tau3 21
    ...
    #define SPIMFCSADIFF_msd_time_aeff1 22
    ...
    #define SPIMFCSADIFF_msd_time_aeff2 23
    ...
    #define SPIMFCSADIFF_msd_time_aeff3 24

}

double QFFitFunctionsTIRFCSDiff3DPixelE2::evaluate(double t, const double* data) const {
...
void QFFitFunctionsTIRFCSDiff3DPixelE2::evaluateDerivatives(double* derivatives, double t, const double* data) const {
}

void QFFitFunctionsTIRFCSDiff3DPixelE2::sortParameter(double *parameterValues, double *error, bool *fix) const {
...
void QFFitFunctionsTIRFCSDiff3DPixelE2::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionsTIRFCSDiff3DPixelE2::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSSDiff_n_components];
    switch(parameter) {
...
unsigned int QFFitFunctionsTIRFCSDiff3DPixelE2::getAdditionalPlotCount(const double* params) {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsTIRFCSDiff3DPixelE2::transformParametersForAdditionalPlot(int plot, double* params) {
