...
unsigned int QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFG::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFG::transformParametersForAdditionalPlot(int plot, double* params) const {
