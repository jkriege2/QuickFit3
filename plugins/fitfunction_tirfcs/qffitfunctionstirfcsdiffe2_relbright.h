...
class QFFitFunctionsTIRFCSDiffE2Diffbright: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("TIR-FCS: 2D Diffusion, different molecular brightnesses (1/e² radii)"); }
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return QObject::tr("TIR-FCS: 2D Diffusion, different molecular brightnesses (1/e² radii)"); }
