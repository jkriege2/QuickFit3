...
#ifndef QFFitFunctionsTIRFCSDiff3DPixelE2NewVeffE2_H
#define QFFitFunctionsTIRFCSDiff3DPixelE2NewVeffE2_H
...
*/
class QFFitFunctionsTIRFCSDiff3DPixelE2: public QFFitFunction {
    public:
        QFFitFunctionsTIRFCSDiff3DPixelE2();
        virtual ~QFFitFunctionsTIRFCSDiff3DPixelE2() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("TIR-FCS: 3D+2D Diffusion (Gaussian, 1/e^2 radii)"); }
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return name(); }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("fcs_tir_pixel_diff3de2"); }
...
#endif // QFFitFunctionsTIRFCSDiff3DPixelE2NewVeffE2_H
