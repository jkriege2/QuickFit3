...
#ifndef QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFR_H
#define QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFR_H
...
*/
class QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFR: public QFFitFunction {
    public:
        QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFR();
        virtual ~QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFR() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("TIR-FCCS: 1-comp. 2D anomalous diffusion (xy), species A+B+AB, c/D per species (rect. pixel, 1/e^2 radii), ACF red"); }
...
#endif // QFFitFunctionsTIRFFCCSFW2DADiffXY2ColorACFR_H
