...
params_VQ=new Array(23.5,24,24.5);
//params_led_brightness=new Array(30,10,5,2,1,0);
params_led_brightness=new Array(30,20,10,5,2,1,0);
for (var j=0; j<params_VQ.length; j++) {
  ...
  for (var i=0; i<params_led_brightness.length; i++) {
    ...
    tools.sleepMS(500);
    instrument.setAcqDescCurrentSample("C21_LED"+params_led_brightness[i]+"mA_"+params_VQ[j]*1000+"mV_1100mVQ_");
