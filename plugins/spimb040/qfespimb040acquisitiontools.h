...
class QFESPIMB040AcquisitionTools {
    public:
         ...
         */
        virtual bool savePreview(QFExtension* extension, QFExtensionCamera* ecamera, int camera, const QString& previewSettingsFilename, const QString& filename, QString* filename32, QMap<QString, QVariant>* acquisitionDescription=NULL, const QString& acquisitionDescriptionPrefix=QString(""))=0;
        ...
        */
        ...
        virtual QString saveMeasuredData(const QString &filenamePrefix, const QList<QFESPIMB040OpticsSetup::measuredValues> &data)=0;
