...
/** \file finddialog.h
  * \ingroup sdff_editor
  *
  * This file contains the "Find Text ..." Dialog for the sdff editor.
  */
...
/** \brief the sdff-editor's "Find text ..." dialog
 *
 *  \ingroup sdff_editor
 *
 *  \image html editor_find.png
 */
class QFESPIMB040FindDialog : public QFDialog, private Ui::FindDialog
{
    Q_OBJECT
private:
...
public:
    ...
    QFESPIMB040FindDialog(QWidget *parent = 0);
    virtual ~QFESPIMB040FindDialog();
