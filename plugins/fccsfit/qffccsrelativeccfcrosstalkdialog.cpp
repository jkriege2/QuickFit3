    ...
    if (acfFCS0 && acfFCS1 && acfRUNIMAGE0 && acfRUNIMAGE1 && ccfFCS && ccfRUNIMAGE) {
           ...
           )
        {
            ...
            if (ok && acf0D && acf0S && acf1D && acf1S && ccfD && ccfS && acf0N>0 && acf1N>0 && ccfN>0) {
                //tim.write("2");
                double* rel0=(double*)malloc(runs*sizeof(double));
                double* rel0_error=(double*)malloc(runs*sizeof(double));
                double* rel1=(double*)malloc(runs*sizeof(double));
                double* rel1_error=(double*)malloc(runs*sizeof(double));
                double* acf0_out=(double*)malloc(runs*sizeof(double));
                double* acf1_out=(double*)malloc(runs*sizeof(double));
                double* ccf_out=(double*)malloc(runs*sizeof(double));
                double* acf0UC_out=(double*)malloc(runs*sizeof(double));
                double* acf1UC_out=(double*)malloc(runs*sizeof(double));
                double* ccfUC_out=(double*)malloc(runs*sizeof(double));
                uint64_t idxA0=0;
                uint64_t idxA1=0;
                uint64_t idxC=0;
