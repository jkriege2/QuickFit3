...
#ifndef QFFCCSPARAMETERINPUTTABLE_H
#define QFFCCSPARAMETERINPUTTABLE_H

#include <QAbstractTableModel>
#include "qfrawdatarecord.h"
class QFFCCSFitEvaluationItem; //forward

class QFFCCSParameterInputTable : public QAbstractTableModel
{
        Q_OBJECT
    public:
        enum QFFCCSParameterInputTableWidgetTypes {
            wtNone=0,
            wtRDRCombobox=1,
        ...
        enum QFFCCSParameterInputTableRoles {
...
#endif // QFFCCSPARAMETERINPUTTABLE_H
