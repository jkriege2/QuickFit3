...
#ifndef QFRDRNumberAndBrightnessProcessingJobThread_H
#define QFRDRNumberAndBrightnessProcessingJobThread_H
#include <stdint.h>
#include <QThread>
#include <QPointer>
...
class QFRDRNumberAndBrightnessProcessingJobThread; // forward
...
/*! \brief job description for correlation
    ...
    The jobs are processed by QFRDRNumberAndBrightnessProcessingJobThread objects (in the run() method) that are
    usually called from a QFRDRNumberAndBrightnessProcessingDialog dialog instance.
    ...
    documentation of QFRDRNumberAndBrightnessProcessingJobThread which actually contains
...
struct IMFCSJob {
    ...
    QPointer<QFRDRNumberAndBrightnessProcessingJobThread> thread;
...
/*! \brief this thread does all the correlation work
    ...
    These jobs (together with objects of this class QFRDRNumberAndBrightnessProcessingJobThread) are usually
    created by QFRDRNumberAndBrightnessProcessingDialog.
...
*/
class QFRDRNumberAndBrightnessProcessingJobThread : public QThread {
        Q_OBJECT
    public:
        enum FileTypes {
            ftCorrelation=0,
        ...
        explicit QFRDRNumberAndBrightnessProcessingJobThread(QFPluginServices* services, QObject *parent = 0);
        ~QFRDRNumberAndBrightnessProcessingJobThread();
        int status() const;
...
#endif // QFRDRNumberAndBrightnessProcessingJobThread_H
