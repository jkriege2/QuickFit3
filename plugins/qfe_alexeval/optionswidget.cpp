...
{
    ui->chkShowToolbarIcon->setChecked(options->getConfigValue("qfe_alexeval/show_toolbar_button", false).toBool());
}

void OptionsWidget::writeSettings(ProgramOptions *options)
{

    options->setConfigValue("qfe_alexeval/show_toolbar_button", ui->chkShowToolbarIcon->isChecked());
