...
double QFFitFunctionsFCCSFWDiff2ColorACFR::evaluate(double t, const double* data) const {
    ...
    double Grr_b=etaR*etaR*cb*QFFitFunctionFCCSFWTriplet(nNonFl, t, thetaT_b, tauT_b)*QFFitFunctionsFCCSFWDiff2ColorCCF_corrfactor(dx, dy, dz, Db, t, wxyR, wxyR, wzR, wzR);
    double Grr_ab=etaR*etaR*cab*QFFitFunctionFCCSFWTriplet(nNonFl, t, thetaT_ab, tauT_ab)*QFFitFunctionsFCCSFWDiff2ColorCCF_corrfactor(dx, dy, dz, Dab, t, wxyR, wxyR, wzR, wzR);
