...
unsigned int QFFitFunctionsFCCSFWDiff2ColorSepACFG::getAdditionalPlotCount(const double* /*params*/) const {
    return 1;
}

QString QFFitFunctionsFCCSFWDiff2ColorSepACFG::transformParametersForAdditionalPlot(int /*plot*/, double* params) const {
