...
#ifndef QFFitFunctionsFCCSFWDiff2ColorTCSepCCF_H
#define QFFitFunctionsFCCSFWDiff2ColorTCSepCCF_H
...
*/
class QFFitFunctionsFCCSFWDiff2ColorTCSepCCF: public QFFCSFitFunctionBase {
    public:
        QFFitFunctionsFCCSFWDiff2ColorTCSepCCF();
        virtual ~QFFitFunctionsFCCSFWDiff2ColorTCSepCCF() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("2-color FCCS: 3D 2-comp. normal diffusion, species A+B+AB, c per species, D1/D2 per channel, CCF"); }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("fccs_fw_diff2colortcsepccf"); }
...
#endif // QFFitFunctionsFCCSFWDiff2ColorTCSepCCF_H
