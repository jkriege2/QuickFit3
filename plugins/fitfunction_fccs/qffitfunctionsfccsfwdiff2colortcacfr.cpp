...
unsigned int QFFitFunctionsFCCSFWDiff2ColorTCACFR::getAdditionalPlotCount(const double* /*params*/) const {
    return 1;
 }

QString QFFitFunctionsFCCSFWDiff2ColorTCACFR::transformParametersForAdditionalPlot(int /*plot*/, double* params) const {
