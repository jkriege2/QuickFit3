...
unsigned int QFFitFunctionFCCSNormalDiff3D::getAdditionalPlotCount(const double* /*params*/) const {
    return 1;
}

QString QFFitFunctionFCCSNormalDiff3D::transformParametersForAdditionalPlot(int /*plot*/, double* params) const {
