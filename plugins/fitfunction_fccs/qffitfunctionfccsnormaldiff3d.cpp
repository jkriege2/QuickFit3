...
QFFitFunctionFCCSNormalDiff3D::QFFitFunctionFCCSNormalDiff3D() {
    ...
    addParameter(IntCombo,     "n_reaction",              "number of rection components",                          "# reaction",               "",           "",                      false,     true,         false,             QFFitFunction::NoError,      0,            0,        1,        1,   0,      2);
    #define FCCS3DDiff_n_reaction 0
    addParameter(FloatNumber,  "nonfl_tau1",              "triplet decay time",                                    "&tau;<sub>trip</sub>",     "usec",       "&mu;s",                 true,      true,         true,              QFFitFunction::DisplayError, 20,           0,        1e8,      0.1, 0  );
    ...
    addParameter(FloatNumber,  "n_particle_ab",           "Particle number N(ab)",                                 "N<sub>ab</sub>",           "",           "",                      true,      true,         true,              QFFitFunction::DisplayError, 5,            1e-10,    1e5,      1,   0);
    #define FCCS3DDiff_n_particle10 3
    addParameter(FloatNumber,  "appn_particle_a",         "apparent particle number from green ACF",               "N<sub>a</sub>+N<sub>ab</sub>", "",       "",                      false,     true,        false,              QFFitFunction::EditError,    10,           1e-10,    1e5,      1,   0);
    #define FCCS3DDiff_appn_particle0 4
    addParameter(FloatNumber,  "n_particle_a",           "corrected particle number from green ACF",               "N<sub>a</sub>",            "",       "",                          false,     false,        false,              QFFitFunction::DisplayError, 5,           1e-10,    1e5,      1,   0);
    #define FCCS3DDiff_n_particle0 5
    addParameter(FloatNumber,  "appn_particle_b",         "apparent particle number from red ACF",                 "N<sub>b</sub>+N<sub>ab</sub>", "",       "",                      false,     true,        false,              QFFitFunction::EditError,    10,           1e-10,    1e5,      1,   0);
    #define FCCS3DDiff_appn_particle1 6
    addParameter(FloatNumber,  "n_particle_b",           "corrected particle number from green ACF",               "N<sub>a</sub>",            "",       "",                          false,     false,        false,              QFFitFunction::DisplayError, 5,           1e-10,    1e5,      1,   0);
    #define FCCS3DDiff_n_particle1 7
    addParameter(FloatNumber,  "diff_coeffc",             "diffusion coefficient",                                 "D<sub>ab</sub>",           "micron^2/s", "&mu;m<sup>2</sup>/s",    true,      true,         true,              QFFitFunction::EditError,    500,          0,        1e50,     1    );
    ...
    addParameter(FloatNumber,  "focus_struct_fac1",       "focus: axial ratio ch. G",                              "&gamma;<sub>g</sub>",      "",           "",                       true,      true,         true,              QFFitFunction::EditError,    6,            0.01,     100,      0.5  );
    #define FCCS3DDiff_focus_struct_fac1 10
    addParameter(FloatNumber,  "focus_struct_fac2",       "focus: axial ratio ch. R",                              "&gamma;<sub>r</sub>",      "",           "",                       true,      true,         true,              QFFitFunction::EditError,    6,            0.01,     100,      0.5  );
    #define FCCS3DDiff_focus_struct_fac2 11
    addParameter(FloatNumber,  "focus_width1",            "focus: lateral radius ch. G",                           "w<sub>g</sub>",            "nm",         "nm",                     false,     true,        false,              QFFitFunction::EditError,    250,          0,        1e4,      1    );
    #define FCCS3DDiff_focus_width1 12
    addParameter(FloatNumber,  "focus_width2",            "focus: lateral radius ch. R",                           "w<sub>r</sub>",            "nm",         "nm",                     false,     true,        false,              QFFitFunction::EditError,    250,          0,        1e4,      1    );
    #define FCCS3DDiff_focus_width2 13
    addParameter(FloatNumber,  "focus_distance",          "focus: distance between ch. G and R",                   "d<sub>rg</sub>",           "nm",         "nm",                     true,     true,         true,               QFFitFunction::EditError,    0,            0,        1e5,      1    );
    #define FCCS3DDiff_distance 14
    addParameter(FloatNumber,  "crosstalk",               "crosstalk coeficient",                                  "crosstalk &kappa;",        "",           "",                       false,    true,         false,              QFFitFunction::EditError,    0.05,         0,        1,        .01, 0,       1 );
    #define FCCS3DDiff_crosstalk 15
    addParameter(FloatNumber,  "count_rate1",             "count rate during measurement, ch. G",                  "count rate I<sub>G</sub>", "Hz",         "Hz",                     false,    true,         false,              QFFitFunction::EditError,    0,            0,        1e50,     1    );
    #define FCCS3DDiff_count_rate1 16
    addParameter(FloatNumber,  "background1",             "background count rate during measurement, ch. G",       "background B<sub>G</sub>", "Hz",         "Hz",                     false,    true,         false,              QFFitFunction::EditError  ,    0,            0,        1e50,     1    );
    #define FCCS3DDiff_background1 17
    addParameter(FloatNumber,  "count_rate2",             "count rate during measurement, ch. R",                  "count rate I<sub>R</sub>", "Hz",         "Hz",                     false,    true,         false,              QFFitFunction::EditError,    0,            0,        1e50,     1    );
    #define FCCS3DDiff_count_rate2 18
    addParameter(FloatNumber,  "background2",             "background count rate during measurement, ch. R",       "background B<sub>R</sub>", "Hz",         "Hz",                     false,    true,         false,              QFFitFunction::EditError  ,    0,            0,        1e50,     1    );
    #define FCCS3DDiff_background2 19
    addParameter(FloatNumber,  "focus_volume",            "focus: effective colume",                               "V<sub>eff,rg</sub>",       "fl",         "fl",                     false,    false,        false,              QFFitFunction::DisplayError, 0.5,          0,        1e50,     1    );
    #define FCCS3DDiff_focus_volume 20
    addParameter(FloatNumber,  "concentration",           "concentration of species ab in focus",                  "C<sub>ab</sub>",           "nM",         "nM",                     false,    false,        false,              QFFitFunction::DisplayError, 0.5,          0,        1e50,     1    );
    #define FCCS3DDiff_concentration 21
    addParameter(FloatNumber,  "equilibconst",            "equilibrium constant",                                  "K<sub>ab</sub>",           "1/M",       "M<sup>-1</sup>",        false,    false,        false,              QFFitFunction::DisplayError, 0.5,          0,        1e50,     1    );
