...
*/
class QFFitFunctionsFCCSFWDiff2ColorTCACFR: public QFFCSFitFunctionBase {
    public:
        QFFitFunctionsFCCSFWDiff2ColorTCACFR();
        virtual ~QFFitFunctionsFCCSFWDiff2ColorTCACFR() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("2-color FCCS: 3D 2-comp. normal diffusion, species A+B+AB, c/D1/D2 per species, ACF red"); }
