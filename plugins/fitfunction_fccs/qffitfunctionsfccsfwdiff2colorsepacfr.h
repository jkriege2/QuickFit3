...
*/
class QFFitFunctionsFCCSFWDiff2ColorSepACFR: public QFFCSFitFunctionBase {
    public:
        QFFitFunctionsFCCSFWDiff2ColorSepACFR();
        virtual ~QFFitFunctionsFCCSFWDiff2ColorSepACFR() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("2-color FCCS: 3D normal diffusion, species A+B+AB, c per species, D per channel, ACF red"); }
