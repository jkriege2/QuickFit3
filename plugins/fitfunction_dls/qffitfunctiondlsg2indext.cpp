...
#define DLSG2_tau4 26
   addParameter(FloatNumber,  "tau5",                    "correlation time 5",                                    "&tau;<sub>5</sub>",        "탎",         "&mu;s",                  false,    false,        false,              QFFitFunction::DisplayError, false, 100,          1e-10,    1e50,     1    );
#define DLSG2_tau5 27
   addParameter(FloatNumber,  "tau6",                    "correlation time 6",                                    "&tau;<sub>6</sub>",        "탎",         "&mu;s",                  false,    false,        false,              QFFitFunction::DisplayError, false, 1000,         1e-10,    1e50,     1    );
#define DLSG2_tau6 28
   addParameter(FloatNumber,  "tau7",                    "correlation time 7",                                    "&tau;<sub>7</sub>",        "탎",         "&mu;s",                  false,    false,        false,              QFFitFunction::DisplayError, false, 10000,        1e-10,    1e50,     1    );
#define DLSG2_tau7 29
   addParameter(FloatNumber,  "tau8",                    "correlation time 8",                                    "&tau;<sub>8</sub>",        "탎",         "&mu;s",                  false,    false,        false,              QFFitFunction::DisplayError, false, 100000,       1e-10,    1e50,     1    );
