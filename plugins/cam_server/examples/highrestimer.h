/*
    ...
    last modification: $LastChangedDate: 2014-09-26 12:39:24 +0200 (Fr, 26 Sep 2014) $  (revision $Rev: 3507 $)
...
# endif
  ...
  #include <sys/time.h>
#else
  #error("your operating system is not supported: you will have to implement this on your systems")
#endif
