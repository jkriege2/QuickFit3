...
#ifndef QFFitFunctionGeneralCosine_H
#define QFFitFunctionGeneralCosine_H
...
*/
class QFFitFunctionGeneralCosine: public QFFitFunction {
    public:
        QFFitFunctionGeneralCosine();
        virtual ~QFFitFunctionGeneralCosine() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QObject::tr("Waveforms: Cosine"); }
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return name(); }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("gen_cos"); }
        /*! \copydoc QFFitFunction::category()   */
        virtual QString category() const { return QObject::tr("General Fit Functions/Waveforms"); }
...
#endif // QFFitFunctionGeneralCosine_H
