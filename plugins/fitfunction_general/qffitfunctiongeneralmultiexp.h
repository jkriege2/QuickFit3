...
#ifndef QFFitFunctionGeneralMultiExp_H
#define QFFitFunctionGeneralMultiExp_H
...
*/
class QFFitFunctionGeneralMultiExp: public QFDecayFitFunctionBase {
    public:
        ...
        virtual QString id() const { return QString("gen_multiexp"); }
...
#endif // QFFitFunctionGeneralMultiExp_H
