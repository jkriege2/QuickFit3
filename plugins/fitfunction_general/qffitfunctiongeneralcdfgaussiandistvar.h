...
class QFFitFunctionGeneralCDFGaussianDistVar: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QObject::tr("Cummulative Distributions (CDF): Gaussian "); }
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return QObject::tr("CDF: Gaussian"); }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("gen_cdf_gaussian"); }
