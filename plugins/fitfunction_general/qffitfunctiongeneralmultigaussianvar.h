...
#ifndef QFFitFunctionGeneralMultiGaussianVar_H
...
class QFFitFunctionGeneralMultiGaussianVar: public QFDistributionFitFunctionBase {
    public:
        ...
        virtual QString name() const { return QObject::tr("Peaks: Multi-Component Gaussian function (1/sqrt(e) width)"); }
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return name(); }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("gen_multigaussian_sqrte"); }
