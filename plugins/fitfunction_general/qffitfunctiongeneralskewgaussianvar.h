...
class QFFitFunctionGeneralSkewGaussianVar: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QObject::tr("Peaks: skewed Gaussian function (1/sqrt(e) width)"); };
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return name(); };
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("gen_skewgaussian_sqrte"); };
...
#endif // QFFitFunctionGeneralSkewGaussianVar_H
