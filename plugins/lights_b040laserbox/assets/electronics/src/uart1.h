...
extern void uart1_init(uint32_t baudrate, uint8_t databits, uint8_t stopbits, uint8_t parity);
...
extern uint8_t uart1_getc_wait(void);
extern int     uart1_getc_nowait(void);
