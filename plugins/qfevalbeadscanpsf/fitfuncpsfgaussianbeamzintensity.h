...
class QFFitFunctionPSFGaussianBeamZIntensity: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QObject::tr("PSF: Gaussian Beam: Intensity(z)"); };
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return name(); };
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("beadscan_psf_gaussianbeam_zintensity"); };
