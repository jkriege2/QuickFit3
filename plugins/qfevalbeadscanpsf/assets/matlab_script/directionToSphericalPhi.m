...
function [ phi ] = directionToSphericalPhi( direction )
%[ phi ] = directionToSphericalTheta( direction ) returns the angle
% phi of spherical coordinates that represent the given direction.
%
