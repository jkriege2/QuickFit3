...
function [ theta ] = directionToSphericalTheta( direction )
%[ theta ] = directionToSphericalTheta( direction ) returns the angle
%theta of spherical coordinates that represent the given direction.
%
