...
cutregion_z = 15;     % size of the region to cut longitudinally
max_intensity = 1;
...
% , 'datarange',datarange
dataout=perform_evaldualcolorzstack(datal, datar, psf_positions, prefix, 'deltaz',deltaz, 'deltaxy', deltaxy,...
