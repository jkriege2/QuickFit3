...
function [ theta phi ] = directionToSphericalAngles( direction )
%[ theta phi ] = directionToSphericalAngles( direction ) returns the angle
%theta and phi of spherical coordinates that represent the given direction.
%
%   Note: the direction does not have to be nromalized, as this is doen by
%         the function!
