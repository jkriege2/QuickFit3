...
#define EDITOR_BUTTON_ACCEPT_FUNC() button_IACCEPT()

// character used to display an up arrow as button description
#define EDITOR_UP_GLYPH 0b11011110
// character used to display an down arrow as button description
#define EDITOR_DOWN_GLYPH 0b11100000
// character used to display an enter arrow as button description
#define EDITOR_ENTER_GLYPH 0b00011100
// character used to display an ACCEPT as button description
