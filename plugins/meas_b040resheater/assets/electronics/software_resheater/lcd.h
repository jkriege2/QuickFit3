...
#define LCD_CONTROLLER_KS0073 3
#define LCD_CONTROLLER_EADOGM LCD_CONTROLLER_ST7036
#define LCD_CONTROLLER_EADIP204_4 LCD_CONTROLLER_KS0073
 ...
 *  .
 */
#define LCD_USED_CONTROLLER LCD_CONTROLLER_EADIP204_4
 ...
 *  .
 */
#define LCD_VOLTAGE LCD_VOLTAGE_5V
...
/** \brief write a character to a specified position
 *
 *  \param x x-position in line
 *  \param y the line to write into [1..4]
 *  \param data the character to write
 */
#define lcd_pos_char(x, y, data) { lcd_cursor(x, y); lcd_putc(data); }
