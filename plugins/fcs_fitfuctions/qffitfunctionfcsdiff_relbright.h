...
#ifndef QFFITFUNCTIONFCSDIFF_RELBRIGHT_H
#define QFFITFUNCTIONFCSDIFF_RELBRIGHT_H
...
*/
class QFFitFunctionFCSDiffDifferentBrightness: public QFFCSFitFunctionBase {
    public:
        QFFitFunctionFCSDiffDifferentBrightness();
        virtual ~QFFitFunctionFCSDiffDifferentBrightness() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QObject::tr("FCS: 3D Normal Diffusion, different molecular brightnesses"); };
...
#endif // QFFITFUNCTIONFCSDIFF_RELBRIGHT_H
