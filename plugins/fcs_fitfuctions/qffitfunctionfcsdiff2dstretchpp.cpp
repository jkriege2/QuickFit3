...
unsigned int QFFitFunctionFCSDiff2DStretchPP::getAdditionalPlotCount(const double* params) {
    return 1;
}

QString QFFitFunctionFCSDiff2DStretchPP::transformParametersForAdditionalPlot(int plot, double* params) {
    if (plot==0) {
