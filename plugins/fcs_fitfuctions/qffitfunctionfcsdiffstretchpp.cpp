...
QFFitFunctionFCSDiffStretchPP::QFFitFunctionFCSDiffStretchPP() {
...
double QFFitFunctionFCSDiffStretchPP::evaluate(double t, const double* data) const {
...
void QFFitFunctionFCSDiffStretchPP::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionFCSDiffStretchPP::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSDiff_n_components];
    int nonfl_comp=data[FCSDiff_n_nonfluorescent];
    switch(parameter) {
...
unsigned int QFFitFunctionFCSDiffStretchPP::getAdditionalPlotCount(const double* /*params*/) const {
    return 1;
}

QString QFFitFunctionFCSDiffStretchPP::transformParametersForAdditionalPlot(int plot, double* params) const {
    if (plot==0) {
