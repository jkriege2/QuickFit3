...
QFFitFunctionFCSDiffDAfterPulse::QFFitFunctionFCSDiffDAfterPulse(bool hasGamma) {
    ...
    #define FCSDiff_diff_coeff3 17
    addParameter(FloatNumber,  "offset",                  "correlation offset",                                    "G<sub>&infin;</sub>",      "",           "",                       true,      true,         true,              QFFitFunction::DisplayError, true, 0,            -10,      10,       0.1  );
    #define FCSDiff_offset 18
...
QString QFFitFunctionFCSDiffDAfterPulse::name() const {
    if (hasGamma) return  QString("FCS: 3D Normal Diffusion, D, N, wxy and gamma, afterpulsing");
    return QString("FCS: 3D Normal Diffusion, D, N, wxy and wz, afterpulsing");
}
...
unsigned int QFFitFunctionFCSDiffDAfterPulse::getAdditionalPlotCount(const double* /*params*/) const {
    return 2;
}

QString QFFitFunctionFCSDiffDAfterPulse::transformParametersForAdditionalPlot(int plot, double* params) const {
    if (plot==0) {
