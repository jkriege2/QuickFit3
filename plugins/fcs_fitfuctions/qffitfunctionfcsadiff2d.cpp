...
unsigned int QFFitFunctionFCSADiff2D::getAdditionalPlotCount(const double* params) {
    return 1;
}

QString QFFitFunctionFCSADiff2D::transformParametersForAdditionalPlot(int plot,  double* params) {
