...
#ifndef QFFitFunctionFCSDiffDAfterPulseAfterPulse_H
#define QFFitFunctionFCSDiffDAfterPulseAfterPulse_H
...
*/
class QFFitFunctionFCSDiffDAfterPulse: public QFFCSFitFunctionBase {
    public:
    QFFitFunctionFCSDiffDAfterPulse(bool hasGamma=true);
    virtual ~QFFitFunctionFCSDiffDAfterPulse() {}
...
#endif // QFFitFunctionFCSDiffDAfterPulseAfterPulse_H
