...
unsigned int QFFitFunctionFCSExp::getAdditionalPlotCount(const double* /*params*/) const {
    return 0;
}

QString QFFitFunctionFCSExp::transformParametersForAdditionalPlot(int /*plot*/, double* /*params*/) const {
