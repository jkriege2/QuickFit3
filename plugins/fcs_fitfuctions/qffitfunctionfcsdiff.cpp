...
unsigned int QFFitFunctionFCSDiff::getAdditionalPlotCount(const double* params) const {
    Q_UNUSED(params);
    return 1;
}

QString QFFitFunctionFCSDiff::transformParametersForAdditionalPlot(int plot, double* params) const {
    Q_UNUSED(plot);
