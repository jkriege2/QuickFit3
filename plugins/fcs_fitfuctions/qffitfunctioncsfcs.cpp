...
unsigned int QFFitFunctionCSFCSDiffD::getAdditionalPlotCount(const double* /*params*/) const {
    return 2;
}

QString QFFitFunctionCSFCSDiffD::transformParametersForAdditionalPlot(int plot, double* params) const {
	if (plot==0) {
