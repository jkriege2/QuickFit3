...
QFFitFunctionFCSFlow::QFFitFunctionFCSFlow() {
    ...
    addParameter(FloatNumber,  "diff_tauf",               "flow time of first component",                          "&tau;<sub>flow</sub>",     "usec",        "&mu;s",                 true,      true,         true,              QFFitFunction::DisplayError, 300,          1e-10,    1e10,     1,   0.1        );
