...
QFFitFunctionFCSADiffDifferentBrightness::QFFitFunctionFCSADiffDifferentBrightness() {
    ...
    #define FCSDiff_focus_struct_fac 24
    ...
    #define FCSDiff_focus_volume 26
    ...
    #define FCSDiff_concentration 27
...
double QFFitFunctionFCSADiffDifferentBrightness::evaluate(double t, const double* data) const {
...
void QFFitFunctionFCSADiffDifferentBrightness::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionFCSADiffDifferentBrightness::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSDiff_n_components];
    int nonfl_comp=data[FCSDiff_n_nonfluorescent];
    switch(parameter) {
...
unsigned int QFFitFunctionFCSADiffDifferentBrightness::getAdditionalPlotCount(const double* /*params*/) const {
    return 1;
}

QString QFFitFunctionFCSADiffDifferentBrightness::transformParametersForAdditionalPlot(int plot, double* params) const {
