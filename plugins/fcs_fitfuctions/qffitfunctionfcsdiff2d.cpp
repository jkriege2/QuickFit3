...
unsigned int QFFitFunctionFCSDiff2D::getAdditionalPlotCount(const double* /*params*/) const {
    return 1;
}

QString QFFitFunctionFCSDiff2D::transformParametersForAdditionalPlot(int /*plot*/, double* params) const {
