...
QFFitFunctionFCSRot::QFFitFunctionFCSRot() {
    ...
    addParameter(FloatNumber,  "rot_tau",                 "rotation decay time",                                   "&tau;<sub>rot</sub>",      "ns",          "ns",                    true,      true,         true,              QFFitFunction::DisplayError, false, 300,           1e-10,    1e10,    1);
    #define FCSSDiff_rot_tau 5
    addParameter(FloatNumber,  "rot_f",                   "rotation fraction",                                     "F<sub>rot</sub>",          "",            "",                      true,      true,         true,              QFFitFunction::DisplayError, false, 0.2,          0,        0.99999,  0.1, 0,      1);
    #define FCSSDiff_rot_f 6
    addParameter(FloatNumber,  "rot_c1",                  "rotation prefactor 1",                                  "c<sub>1</sub>",            "",            "",                      false,     true,        false,              QFFitFunction::NoError,      false, 860.0/9.0,    0,        1e10,     0.1  );
    #define FCSSDiff_rot_c1 7
    addParameter(FloatNumber,  "rot_c2",                  "rotation prefactor 2",                                  "c<sub>2</sub>",            "",            "",                      false,     true,        false,              QFFitFunction::NoError,      false, 4,            0,        1e10,     0.1  );
    ...
    addParameter(FloatNumber,  "diff_rot",                "rotation diffusion coefficient",                        "&Theta;<sub>rot</sub>",    "1/s",        "s<sup>-1</sup>",         false,    false,        false,              QFFitFunction::DisplayError, false, 500,          0,        1e50,     1    );
