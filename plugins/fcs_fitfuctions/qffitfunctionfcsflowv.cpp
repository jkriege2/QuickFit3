...
unsigned int QFFitFunctionFCSFlowV::getAdditionalPlotCount(const double* /*params*/) const {
    return 2;
}

QString QFFitFunctionFCSFlowV::transformParametersForAdditionalPlot(int plot, double* params) const {
    if (plot==0) {
