...
class QFFitFunctionFCSDiff2DDifferentBrightness: public QFFitFunction {
    public:
        QFFitFunctionFCSDiff2DDifferentBrightness();
        virtual ~QFFitFunctionFCSDiff2DDifferentBrightness() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("FCS: Normal Diffusion 2D, different molecular brightnesses"); };
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const { return QString("fcs_diff2d_diffbright"); };
