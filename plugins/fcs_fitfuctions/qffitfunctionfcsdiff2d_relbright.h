...
#ifndef QFFITFUNCTIONFCSDIFF2D_RELBRIGHT_H
#define QFFITFUNCTIONFCSDIFF2D_RELBRIGHT_H
#include "qfpluginfitfunction.h"
#include "qffitfunction.h"
#include "qfgeneralfitfunctionbase.h"

/*! \brief plugin class for FCS Normal Diffusion Fit Functions with different brightnesses of the species
...
*/
class QFFitFunctionFCSDiff2DDifferentBrightness: public QFFCSFitFunctionBase {
    public:
        QFFitFunctionFCSDiff2DDifferentBrightness(bool isTIRF=false);
        virtual ~QFFitFunctionFCSDiff2DDifferentBrightness() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const {
            if (!isTIRF) return QObject::tr("FCS: 2D Normal Diffusion, different molecular brightnesses");
            else return QObject::tr("TIR-FCS: 2D Normal Diffusion, different molecular brightnesses (Gaussian, 1/e^2 radii)");
        }
        /*! \copydoc QFFitFunction::id()   */
        virtual QString id() const {
            if(!isTIRF) return QString("fcs_diff2d_diffbright");
            else return QString("fcs_tir_diff2d_diffbright");
        }
...
#endif // QFFITFUNCTIONFCSDIFF2D_RELBRIGHT_H
