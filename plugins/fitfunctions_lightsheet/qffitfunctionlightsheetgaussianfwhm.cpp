...
unsigned int QFFitFunctionLightsheetGaussianFWHM::getAdditionalPlotCount(const double* params) {
...
QString QFFitFunctionLightsheetGaussianFWHM::transformParametersForAdditionalPlot(int plot, double* params) {
