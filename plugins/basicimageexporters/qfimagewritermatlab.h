...
#ifndef QFIMAGEWRITERMATLAB_H
#define QFIMAGEWRITERMATLAB_H
...
*/
class QFImageWriterMatlab: public QFExporterImageSeries {
    public:
        QFImageWriterMatlab();
        virtual ~QFImageWriterMatlab();
    ...
    private:
        TinyMATWriterFile* file;
        QList<QVector<double> > data;
        int frames;

};

#endif // QFIMAGEWRITERMATLAB_H
