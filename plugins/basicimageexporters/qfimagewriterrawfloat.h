...
#ifndef QFIMAGEWRITERRAWFLOAT_H
#define QFIMAGEWRITERRAWFLOAT_H
...
*/
class QFImageWriterRAWFloat: public QFExporterImageSeries {
    public:
        QFImageWriterRAWFloat();
        virtual ~QFImageWriterRAWFloat();
