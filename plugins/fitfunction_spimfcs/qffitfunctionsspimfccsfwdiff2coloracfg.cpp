...
double QFFitFunctionsSPIMFCCSFWDiff2ColorACFG_pixelcorrfactor(double a, double dx, double D, double t, double wg, double wr) {
...
double QFFitFunctionsSPIMFCCSFWDiff2ColorACFG_zcorrfactor(double dz, double D, double t, double wg, double wr) {
...
double QFFitFunctionsSPIMFCCSFWDiff2ColorACFG::evaluate(double t, const double* data) const {
    ...
    double cfac=QFFitFunctionsSPIMFCCSFWDiff2ColorACFG_pixelcorrfactor(a, dx, D1, t, wxy1, wxy2)*
                QFFitFunctionsSPIMFCCSFWDiff2ColorACFG_pixelcorrfactor(a, dy, D1, t, wxy1, wxy2)*
                QFFitFunctionsSPIMFCCSFWDiff2ColorACFG_zcorrfactor(dz, D1, t, sigmaz1, sigmaz2);
