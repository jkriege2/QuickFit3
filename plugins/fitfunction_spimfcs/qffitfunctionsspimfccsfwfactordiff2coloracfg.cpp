...
QFFitFunctionsSPIMFCCSFWFactorDiff2ColorACFG::QFFitFunctionsSPIMFCCSFWFactorDiff2ColorACFG() {
    ...
    #define FCCSDiff_diff_factorab 3
    ...
    #define FCCSDiff_diff_coeffab 4
    ...
    #define FCCSDiff_pixel_width 11
    ...
    #define FCCSDiff_molbrightness_a 16

}


double QFFitFunctionsSPIMFCCSFWFactorDiff2ColorACFG::evaluate(double t, const double* data) const {
...
void QFFitFunctionsSPIMFCCSFWFactorDiff2ColorACFG::calcParameter(double* data, double* error) const {
    const double cab=data[FCCSDiff_concentrationab]*6.022e-1; // FCCSDiff_concentrationab given in 1e-9*6.022e23 particles/litre but c should be in particles per µm³= particles/10^{-15}litres=1e15 particles/litre
    double ecab=0;
    const double ca=data[FCCSDiff_concentrationa]*6.022e-1; // FCCSDiff_concentrationa given in 1e-9*6.022e23 particles/litre but c should be in particles per µm³= particles/10^{-15}litres=1e15 particles/litre
    double eca=0;
...
bool QFFitFunctionsSPIMFCCSFWFactorDiff2ColorACFG::isParameterVisible(int parameter, const double* data) const {
...
unsigned int QFFitFunctionsSPIMFCCSFWFactorDiff2ColorACFG::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSFWFactorDiff2ColorACFG::transformParametersForAdditionalPlot(int plot, double* params) const {
