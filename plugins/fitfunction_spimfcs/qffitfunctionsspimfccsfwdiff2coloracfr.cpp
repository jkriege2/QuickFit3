...
double QFFitFunctionsSPIMFCCSFWDiff2ColorACFR_pixelcorrfactor(double a, double dx, double D, double t, double wg, double wr) {
...
double QFFitFunctionsSPIMFCCSFWDiff2ColorACFR_zcorrfactor(double dz, double D, double t, double wg, double wr) {
...
double QFFitFunctionsSPIMFCCSFWDiff2ColorACFR::evaluate(double t, const double* data) const {
    ...
    double cfac=QFFitFunctionsSPIMFCCSFWDiff2ColorACFR_pixelcorrfactor(a, dx, D1, t, wxy1, wxy2)*
                QFFitFunctionsSPIMFCCSFWDiff2ColorACFR_pixelcorrfactor(a, dy, D1, t, wxy1, wxy2)*
                QFFitFunctionsSPIMFCCSFWDiff2ColorACFR_zcorrfactor(dz, D1, t, sigmaz1, sigmaz2);
