...
class QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFG: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("2-color SPIM-FCCS: 2-comp. 3D normal diffusion, species A+B+AB, c/D1/D2 per species (rect. pixel, 1/e^2 radii), ACF green"); }
