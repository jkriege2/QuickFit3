...
*/
class QFFitFunctionsSPIMFCCSFWADiff2ColorCCF: public QFFCSLargeFocusFitFunctionBase {
    public:
        QFFitFunctionsSPIMFCCSFWADiff2ColorCCF();
        virtual ~QFFitFunctionsSPIMFCCSFWADiff2ColorCCF() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("2-color SPIM-FCCS (camera): 3D anomalous diffusion, species A+B+AB, c/Gamma/alpha per species, 2-color (rect. pixel, 1/e^2 radii), CCF"); }
