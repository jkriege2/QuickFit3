...
*/
class QFFitFunctionsSPIMFCCSFW2CSepDiff2ColorACFR: public QFFCSLargeFocusFitFunctionBase {
    public:
        QFFitFunctionsSPIMFCCSFW2CSepDiff2ColorACFR();
        virtual ~QFFitFunctionsSPIMFCCSFW2CSepDiff2ColorACFR() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("2-color SPIM-FCCS (camera): 2-comp. normal diffusion, species A+B+AB, c per species, D1/D2 per channel (rect. pixel, 1/e^2 radii), ACF red"); }
