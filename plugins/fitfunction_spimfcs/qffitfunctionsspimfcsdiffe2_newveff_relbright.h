...
class QFFitFunctionsSPIMFCSDiffE2NewVeffDiffBright: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("SPIM-FCS: Diffusion, differen moleculart brightnesses (1/e² radii, new Veff)"); }
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return QObject::tr("SPIM-FCS: Diffusion, different molecular brightnesses (1/e² radii, new Veff)"); }
