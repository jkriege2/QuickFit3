...
*/
class QFFitFunctionsSPIMFCCSFWDiff2ColorCCF: public QFFCSLargeFocusFitFunctionBase {
    public:
        QFFitFunctionsSPIMFCCSFWDiff2ColorCCF();
        virtual ~QFFitFunctionsSPIMFCCSFWDiff2ColorCCF() {}
        /*! \copydoc QFFitFunction::name()   */
        virtual QString name() const { return QString("2-color SPIM-FCCS (camera): 3D normal diffusion, species A+B+AB, c/D per species (rect. pixel, 1/e^2 radii), CCF"); }
