...
unsigned int QFFitFunctionsSPIMFCCSFW2CSepADiff2ColorACFG::getAdditionalPlotCount(const double* params) {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSFW2CSepADiff2ColorACFG::transformParametersForAdditionalPlot(int plot, double* params) {
