...
class QFFitFunctionsSPIMFCCSFWADiff2ColorACFR: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("2-color SPIM-FCCS: 3D anomalous diffusion, species A+B+AB, c/Gamma/alpha per species (rect. pixel, 1/e^2 radii), ACF red"); }
