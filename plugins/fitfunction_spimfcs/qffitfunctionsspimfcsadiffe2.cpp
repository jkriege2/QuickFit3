...
unsigned int QFFitFunctionsSPIMFCSADiffE2::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCSADiffE2::transformParametersForAdditionalPlot(int plot, double* params) const {
