...
QFFitFunctionsSPIMFCSDiffCE2::QFFitFunctionsSPIMFCSDiffCE2() {
    ...
    #define SPIMFCSADIFF_msd_tau 15
    ...
    #define SPIMFCSADIFF_msd_at_tau1 16
    ...
    #define SPIMFCSADIFF_msd_at_tau2 17
    ...
    #define SPIMFCSADIFF_msd_at_tau3 18
    ...
    #define SPIMFCSADIFF_focus_effA 19
    ...
    #define SPIMFCSADIFF_msd_time_aeff1 20
    ...
    #define SPIMFCSADIFF_msd_time_aeff2 21
    ...
    #define SPIMFCSADIFF_msd_time_aeff3 22
...
unsigned int QFFitFunctionsSPIMFCSDiffCE2::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCSDiffCE2::transformParametersForAdditionalPlot(int plot, double* params) const {
