...
QFFitFunctionsSPIMFCCSDiff2Color::QFFitFunctionsSPIMFCCSDiff2Color() {
    ...
    addParameter(FloatNumber,  "concentration_ab",         "particle concentration of species ab in focus",       "C<sub>ab</sub>",           "nM",         "nM",                     true,      true,          true,              QFFitFunction::DisplayError, false, 10,          0,        1e50,     1    );
    #define FCCSDiff_concentrationab 0
    ...
    #define FCCSDiff_diff_coeff1 1
    addParameter(FloatNumber,  "offset",                  "correlation offset",                                   "G<sub>&infin;</sub>",      "",           "",                       true,      true,         true,              QFFitFunction::DisplayError, true, 0,            -10,      10,       0.1  );
    #define FCCSDiff_offset 2
    ...
    #define FCCSDiff_focus_distancex 3
    ...
    #define FCCSDiff_focus_distancey 4
    ...
    #define FCCSDiff_focus_distancez 5
    ...
    #define FCCSDiff_focus_height2 8
    ...
    #define FCCSDiff_count_rate2 13
    ...
    #define FCCSDiff_background2 14
...
double QFFitFunctionsSPIMFCCSDiff2Color::evaluate(double t, const double* data) const {
    const double c=data[FCCSDiff_concentrationab]*6.022e-1; // FCCSDiff_concentrationab given in 1e-9*6.022e23 particles/litre but c should be in particles per µm³= particles/10^{-15}litres=1e15 particles/litre
    ...
    return offset+cfac/c*backfactor;
}
