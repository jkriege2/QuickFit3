...
#include <QDebug>
QFFitFunctionsSPIMFCCSFWADiff2ColorACFR::QFFitFunctionsSPIMFCCSFWADiff2ColorACFR() {
    ...
    #define FCCSDiff_molbrightness_a 27
    ...
    #define FCCSDiff_molbrightness_b 28
}


double QFFitFunctionsSPIMFCCSFWADiff2ColorACFR::evaluate(double t, const double* data) const {
...
bool QFFitFunctionsSPIMFCCSFWADiff2ColorACFR::isParameterVisible(int parameter, const double* data) const {
...
unsigned int QFFitFunctionsSPIMFCCSFWADiff2ColorACFR::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSFWADiff2ColorACFR::transformParametersForAdditionalPlot(int plot, double* params) const {
