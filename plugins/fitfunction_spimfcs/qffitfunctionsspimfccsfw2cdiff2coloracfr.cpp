...
unsigned int QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::getAdditionalPlotCount(const double* params) {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::transformParametersForAdditionalPlot(int plot, double* params) {
