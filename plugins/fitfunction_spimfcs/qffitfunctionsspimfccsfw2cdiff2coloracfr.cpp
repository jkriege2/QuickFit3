...
#include <QDebug>
QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR() {
    ...
    #define FCCSDiff_diff_coeff2a 4
    ...
    #define FCCSDiff_diff_coeff2b 7
    ...
    #define FCCSDiff_diff_coeff2ab 10
    ...
    #define FCCSDiff_molbrightness_a 30
    ...
    #define FCCSDiff_molbrightness_b 31
}


double QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::evaluate(double t, const double* data) const {
...
void QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::calcParameter(double* data, double* error) const {
    const double cab=data[FCCSDiff_concentrationab]*6.022e-1; // FCCSDiff_concentrationab given in 1e-9*6.022e23 particles/litre but c should be in particles per µm³= particles/10^{-15}litres=1e15 particles/litre
    double ecab=0;
    const double ca=data[FCCSDiff_concentrationa]*6.022e-1; // FCCSDiff_concentrationa given in 1e-9*6.022e23 particles/litre but c should be in particles per µm³= particles/10^{-15}litres=1e15 particles/litre
    double eca=0;
...
bool QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::isParameterVisible(int parameter, const double* data) const {
...
unsigned int QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSFW2CDiff2ColorACFR::transformParametersForAdditionalPlot(int plot, double* params) const {
