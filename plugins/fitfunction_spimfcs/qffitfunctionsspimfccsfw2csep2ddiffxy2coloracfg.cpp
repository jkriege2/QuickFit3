...
unsigned int QFFitFunctionsSPIMFCCSFW2CSep2DDiffXY2ColorACFG::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSFW2CSep2DDiffXY2ColorACFG::transformParametersForAdditionalPlot(int plot, double* params) const {
