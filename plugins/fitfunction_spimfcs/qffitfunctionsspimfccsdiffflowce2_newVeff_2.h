...
class QFFitFunctionsSPIMFCCSDiffFlowCENewVeff2Global: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("SPIM-FCCS: Diffusion+Flow+Global Decay, 2-pixel crosscorrelation (1/e^2 radii, new Veff)"); };
        /** \copydoc QFFitFunction::shortName() */
        virtual QString shortName() const { return QObject::tr("SPIM-FCCS: Diffusion+Flow+Global Decay (1/e^2 radii, new Veff)"); };
