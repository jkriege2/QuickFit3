...
inline double QFFitFunctionsFCCSFWDiff2ColorCCF_pixelcorrfactor(double a, double dx, double D, double t, double wg, double wr) {
...
inline double QFFitFunctionsFCCSFWDiff2ColorCCF_corrfactor(double a, double dx, double dy, double dz, double D, double t, double wg, double wr, double zg, double zr) {
    return QFFitFunctionsFCCSFWDiff2ColorCCF_pixelcorrfactor(a, dx, D, t, wg, wr)*
           QFFitFunctionsFCCSFWDiff2ColorCCF_pixelcorrfactor(a, dy, D, t, wg, wr)*
           QFFitFunctionsFCCSFWDiff2ColorCCF_corrfactor(dz, D, t, zg, zr);
}

inline double QFFitFunctionsFCCSFWADiff2ColorCCF_pixelcorrfactor(double a, double dx, double Gamma, double alpha, double t, double wg, double wr) {
...
inline double QFFitFunctionsFCCSFWADiff2ColorCCF_corrfactor(double a, double dx, double dy, double dz, double Gamma, double alpha, double t, double wg, double wr, double zg, double zr) {
    return QFFitFunctionsFCCSFWADiff2ColorCCF_pixelcorrfactor(a, dx, Gamma, alpha, t, wg, wr)*
           QFFitFunctionsFCCSFWADiff2ColorCCF_pixelcorrfactor(a, dy, Gamma, alpha, t, wg, wr)*
