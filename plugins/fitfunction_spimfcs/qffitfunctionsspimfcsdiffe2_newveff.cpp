...
QFFitFunctionsSPIMFCSDiffE2NewVeff::QFFitFunctionsSPIMFCSDiffE2NewVeff() {
    ...
    #define SPIMFCSADIFF_focus_effA 22
    ...
    #define SPIMFCSADIFF_msd_time_aeff1 23
    ...
    #define SPIMFCSADIFF_msd_time_aeff2 24
    ...
    #define SPIMFCSADIFF_msd_time_aeff3 25


}

double QFFitFunctionsSPIMFCSDiffE2NewVeff::evaluate(double t, const double* data) const {
...
void QFFitFunctionsSPIMFCSDiffE2NewVeff::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionsSPIMFCSDiffE2NewVeff::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSSDiff_n_components];
    switch(parameter) {
...
unsigned int QFFitFunctionsSPIMFCSDiffE2NewVeff::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCSDiffE2NewVeff::transformParametersForAdditionalPlot(int plot, double* params) const {
