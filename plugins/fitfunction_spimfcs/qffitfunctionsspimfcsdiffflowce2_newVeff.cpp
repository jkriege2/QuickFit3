...
QFFitFunctionsSPIMFCSDiffFlowCENewVeff2::QFFitFunctionsSPIMFCSDiffFlowCENewVeff2() {
...
double QFFitFunctionsSPIMFCSDiffFlowCENewVeff2::evaluate(double t, const double* data) const {
...
void QFFitFunctionsSPIMFCSDiffFlowCENewVeff2::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionsSPIMFCSDiffFlowCENewVeff2::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSSDiff_n_components];
    switch(parameter) {
