...
class QFFitFunctionsSPIMFCCSFW2CSep2DDiffXZ2ColorACFG: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("2-color SPIM-FCCS: 2-comp. 2D diffusion (xz), species A+B+AB, c per species, D1/D2 per channel (rect. pixel, 1/e^2 radii), ACF green"); }
