...
QFFitFunctionsSPIMFCCSADiffCENewVeff2::QFFitFunctionsSPIMFCCSADiffCENewVeff2() {
    ...
    #define FCCSDiff_focus_height 16
    ...
    #define FCCSDiff_focus_volume 19
    ...
    #define FCCSDiff_concentration 21
    ...
    #define FCCSDiff_cpm 24

}

double QFFitFunctionsSPIMFCCSADiffCENewVeff2::evaluate(double t, const double* data) const {
    ...
    double cfac=r1*QFFitFunctionsSPIMFCCSFWADiff2ColorCCF_corrfactor(a, dx, dy, 0, G1, a1, t, wxy, wxy, wz, wz);
    if (comp>1) cfac=cfac+r2*QFFitFunctionsSPIMFCCSFWADiff2ColorCCF_corrfactor(a, dx, dy, 0, G2, a2, t, wxy, wxy, wz, wz);
    if (comp>2) cfac=cfac+r3*QFFitFunctionsSPIMFCCSFWADiff2ColorCCF_corrfactor(a, dx, dy, 0, G3, a3, t, wxy, wxy, wz, wz);
...
void QFFitFunctionsSPIMFCCSADiffCENewVeff2::calcParameter(double* data, double* error) const {
...
bool QFFitFunctionsSPIMFCCSADiffCENewVeff2::isParameterVisible(int parameter, const double* data) const {
    int comp=data[FCSSDiff_n_components];
    switch(parameter) {
...
unsigned int QFFitFunctionsSPIMFCCSADiffCENewVeff2::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSADiffCENewVeff2::transformParametersForAdditionalPlot(int plot, double* params) const {
