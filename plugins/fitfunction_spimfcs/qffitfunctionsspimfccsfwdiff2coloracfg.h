...
class QFFitFunctionsSPIMFCCSFWDiff2ColorACFG: public QFFitFunction {
    public:
        ...
        virtual QString name() const { return QString("2-color SPIM-FCCS (camera): 3D normal diffusion, species A+B+AB, c/D per species (rect. pixel, 1/e^2 radii), ACF green"); }
