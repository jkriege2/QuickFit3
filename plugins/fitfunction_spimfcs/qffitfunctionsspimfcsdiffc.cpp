...
double QFFitFunctionsSPIMFCSDiffC::evaluate(double t, const double* data) const {
    ...
    const double c=data[FCSSDiff_concentration]*6.022e-1; // FCSSDiff_concentration given in 1e-9*6.022e23 particles/litre but c should be in particles per µm³= particles/10^{-15}litres=1e15 particles/litre
