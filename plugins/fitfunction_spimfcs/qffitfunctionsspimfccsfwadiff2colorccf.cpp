...
QFFitFunctionsSPIMFCCSFWADiff2ColorCCF::QFFitFunctionsSPIMFCCSFWADiff2ColorCCF() {
    ...
    #define FCCSDiff_fraction_abmax 5
    ...
    #define FCCSDiff_diff_acoeffb 9
    ...
    #define FCCSDiff_diff_alphab 10
    ...
    #define FCCSDiff_diff_acoeffab 11
    ...
    #define FCCSDiff_diff_alphaab 12
    ...
    #define FCSSDiff_focus_volume1 23
    ...
    #define FCSSDiff_focus_volume2 24
    ...
    #define FCCSDiff_count_rate1 25
    ...
    #define FCCSDiff_background1 26
    ...
    #define FCCSDiff_count_rate2 27
    ...
    #define FCCSDiff_background2 28
    ...
    #define FCCSDiff_brightness_a 29
    ...
    #define FCCSDiff_brightness_b 30
    ...
    #define FCCSDiff_molbrightness_a 31
    ...
    #define FCCSDiff_molbrightness_b 32
}
...
double QFFitFunctionsSPIMFCCSFWADiff2ColorCCF::evaluate(double t, const double* data) const {
    ...
    // double Grr_b=etaR*etaR*cb*QFFitFunctionsSPIMFCCSFWADiff2ColorCCF_corrfactor(a, 0, 0, 0, Db, alphab, t, wxyR, wxyR, wzR, wzR);
    // double Grr_ab=etaR*etaR*cab*QFFitFunctionsSPIMFCCSFWADiff2ColorCCF_corrfactor(a, 0, 0, 0, Dab, alphaab, t, wxyR, wxyR, wzR, wzR);
     double Ggg_a=etaG*etaG*ca*QFFitFunctionsSPIMFCCSFWADiff2ColorCCF_corrfactor(a, 0, 0, 0, Da, alphaa ,t, wxyG, wxyG, wzG, wzG);
     double Ggg_ab=etaG*etaG*cab*QFFitFunctionsSPIMFCCSFWADiff2ColorCCF_corrfactor(a, 0, 0, 0, Dab, alphaab, t, wxyG, wxyG, wzG, wzG);
...
unsigned int QFFitFunctionsSPIMFCCSFWADiff2ColorCCF::getAdditionalPlotCount(const double* params) const {

    Q_UNUSED(params);
    return 0;
}

QString QFFitFunctionsSPIMFCCSFWADiff2ColorCCF::transformParametersForAdditionalPlot(int plot, double* params) const {
