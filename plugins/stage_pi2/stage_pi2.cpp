...
void QFExtensionLinearStagePI2::selectAxis(int i) {
...
void QFExtensionLinearStagePI2::sendCommand(std::string command) {
    com.write(command+"\x0D");
}

std::string QFExtensionLinearStagePI2::queryCommand(std::string command) {
    std::string res="";
...
void QFExtensionLinearStagePI2::checkComError() {
    QMutexLocker lock(mutexSerial);
...
bool QFExtensionLinearStagePI2::checkComConnected() {
    QMutexLocker lock(mutexSerial);
