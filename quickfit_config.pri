...
QMAKE_CXXFLAGS += -Wno-unused-variable -Wno-unused-but-set-variable -Werror=return-type $${CXXTUNE} -msse -msse2 -mmmx -m3dnow -mfpmath=sse -ftree-vectorize -malign-double -funroll-loops -flto 
QMAKE_LDFLAGS=-flto 
