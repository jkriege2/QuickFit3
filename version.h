...
#define QF_THANKS_TO "Jan Buchholz, Tabea Elbel, Dr. Nicolas Dross, Dr. Gy\xF6rgy V\xE1mosi, Dr. Vera B\xF6hm, Prof. J\xF6rg Langowski, Dr. Katalin T\xF2th, PD Dr. Christoh Garbe, Prof. Dr. Thorsten Wohland"
...
#define QF_LICENSE QT_TR_NOOP("<b>parts GNU Lesser General Public License (LGPL >2.0) and parts GNU General Public License (GPL >3.0) </b><br><br><small><i>Also: This is POSTCARD-ware, so if you like the program and use it, please let us know by sending a nice postcard from your place on the world to:</i><br>DKFZ (German Cancer Research Center)<br>Dept. B040 (Biophysics of Macromolecules): Jan W.  Krieger<br>Im Neuenheimer Feld 580<br>D-69120 Heidelberg,  GERMANY</small>")
