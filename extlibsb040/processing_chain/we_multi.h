#ifndef __WE_MULTI_H__
#define __WE_MULTI_H__
...
{ 
	...
	public:
		we_sink_source(QWidget *parent, unsigned int frame_count, unsigned int frame_size_x, unsigned int frame_size_y) : worker_element(parent,frame_count)
		{
			/** delte old thread */
			delete thread;
			thread = NULL;
