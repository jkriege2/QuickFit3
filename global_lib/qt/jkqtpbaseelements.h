...
class LIB_EXPORT JKQTPcoordinateAxis: public QObject {
    ...
    public:
        ...
        GET_MACRO(double, tickSpacing)
        GET_MACRO(int, labelDigits)
        GET_MACRO(bool, autoAxisSpacing)
        GET_MACRO(bool, minorTickLabelsEnabled)
        GET_MACRO(bool, logAxis)
        GET_MACRO(bool, inverted)
        GET_MACRO(double, logAxisBase)
        GET_MACRO(double, userTickSpacing)
        GET_MACRO(double, userLogTickSpacing)
        GET_MACRO(JKQTPCAlabelType, labelType)
        GET_MACRO(QString, axisLabel)
        GET_MACRO(JKQTPlabelPosition, labelPosition)
        GET_MACRO(QString, labelFont)
        GET_MACRO(double, labelFontSize)
        GET_MACRO(QString, tickLabelFont)
        GET_MACRO(double, tickLabelFontSize)
        GET_MACRO(double, minorTickLabelFontSize)
        GET_MACRO(bool, minorTickLabelFullNumber)
        GET_MACRO(double, tickLabelAngle)
        GET_MACRO(unsigned int, minTicks)
        GET_MACRO(unsigned int, minorTicks)
        GET_MACRO(double, tickOutsideLength)
        GET_MACRO(double, minorTickOutsideLength)
        GET_MACRO(QColor, axisColor)
        GET_MACRO(bool, showZeroAxis)
        GET_MACRO(QColor, gridColor)
        GET_MACRO(QColor, minorGridColor)
        GET_MACRO(double, gridWidth)
        GET_MACRO(Qt::PenStyle, gridStyle)
        GET_MACRO(double, minorGridWidth)
        GET_MACRO(Qt::PenStyle, minorGridStyle)
        GET_MACRO(QString, tickTimeFormat)
        GET_MACRO(QString, tickDateFormat)
        GET_MACRO(QString, tickDateTimeFormat)
        GET_MACRO(JKQTPLabelTickMode, tickMode)

        GET_MACRO(JKQTPCAdrawMode, drawMode1)
        GET_MACRO(JKQTPCAdrawMode, drawMode2)
        GET_MACRO(double, minorTickWidth)
        GET_MACRO(double, tickWidth)
        GET_MACRO(double, lineWidth)
        GET_MACRO(double, lineWidthZeroAxis)
        GET_MACRO(double, tickLabelDistance)
        GET_MACRO(double, labelDistance)
        GET_MACRO(bool, drawGrid)
        GET_MACRO(bool, drawMinorGrid)
        GET_SET_MACRO(bool, autoLabelDigits)
        GET_MACRO(JKQtBasePlotter*, parent)
        GET_SET_MACRO(bool, doUpdateScaling)
