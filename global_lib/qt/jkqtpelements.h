...
class LIB_EXPORT JKQTPgraph: public QObject {
    ...
    public:
        ...
        GET_SET_VMACRO(QString, title)
        GET_SET_MACRO(long long, datarange_start)
        GET_SET_MACRO(long long, datarange_end)
        GET_SET_MACRO(bool, visible)
...
class LIB_EXPORT JKQTPxyGraph: public JKQTPgraph {
    ...
    public:
        ...
        GET_SET_MACRO(int, xColumn)
        GET_SET_MACRO(int, yColumn)
        GET_SET_MACRO(DataSortOrder, sortData)
...
class LIB_EXPORT JKQTPsingleColumnGraph: public JKQTPgraph {
    ...
    public:
        ...
        GET_SET_MACRO(int, dataColumn)
        GET_SET_MACRO(QColor, color)
        GET_SET_MACRO(Qt::PenStyle, style)
        GET_SET_MACRO(double, lineWidth)
        GET_SET_MACRO(DataSortOrder, sortData)
        /** \brief sets the property sortData to the specified \a __value. \details Description of the parameter sortData is: <CENTER>\copybrief sortData.</CENTER> \see sortData for more information */
        inline void set_sortData(int __value) {
            sortData=(DataSortOrder)__value;
...
class LIB_EXPORT JKQTPPeakStreamGraph: public JKQTPsingleColumnGraph {
    ...
    public:
        ...
        GET_SET_MACRO(double, baseline)
        GET_SET_MACRO(double, peakHeight)
        GET_SET_MACRO(bool, yPeaks)
        GET_SET_MACRO(bool, drawBaseline)
...
class LIB_EXPORT JKQTPgraphErrors {
    public:
        ...
        GET_SET_MACRO(QColor, errorColor)
        GET_SET_MACRO(Qt::PenStyle, errorStyle)
        GET_SET_MACRO(double, errorWidth)
        GET_SET_MACRO(QColor, errorFillColor)
        GET_SET_MACRO(Qt::BrushStyle, errorFillStyle)
        GET_SET_MACRO(double, errorbarSize)
...
class LIB_EXPORT JKQTPxGraphErrors: public JKQTPgraphErrors {
    public:
        ...
        GET_SET_MACRO(bool, xErrorSymmetric)
        GET_MACRO(int, xErrorColumnLower)
        GET_MACRO(int, xErrorColumn)
        GET_SET_MACRO(JKQTPerrorPlotstyle, xErrorStyle)
...
class LIB_EXPORT JKQTPyGraphErrors: public JKQTPgraphErrors {
    public:
        ...
        GET_SET_MACRO(bool, yErrorSymmetric)
        GET_MACRO(int, yErrorColumnLower)
        GET_MACRO(int, yErrorColumn)
        GET_SET_MACRO(JKQTPerrorPlotstyle, yErrorStyle)
...
class LIB_EXPORT JKQTPxyLineGraph: public JKQTPxyGraph {
    ...
    public:
        ...
        GET_SET_MACRO(QColor, color)
        GET_SET_MACRO(QColor, fillColor)
        GET_SET_MACRO(Qt::PenStyle, style)
        GET_SET_MACRO(double, lineWidth)
        GET_SET_MACRO(JKQTPgraphSymbols, symbol)
        GET_SET_MACRO(double, symbolWidth)
        GET_SET_MACRO(double, symbolSize)
        GET_SET_MACRO(bool, drawLine)
        GET_SET_MACRO(bool, drawSelectionLine)
        GET_SET_MACRO(QColor, selectionLineColor)
...
class LIB_EXPORT JKQTPxyParametrizedScatterGraph: public JKQTPxyLineGraph, public JKQTPColorPaletteTools {
    ...
    public:
        ...
        GET_SET_MACRO(int, sizeColumn)
        GET_SET_MACRO(int, colorColumn)
        GET_SET_MACRO(int, symbolColumn)
        GET_SET_MACRO(bool, colorColumnContainsRGB)
        GET_SET_MACRO(bool, gridModeForSymbolSize);
        GET_SET_MACRO(double, gridDeltaX);
        GET_SET_MACRO(double, gridDeltaY);
        GET_SET_MACRO(double, gridSymbolFractionSize);
...
class LIB_EXPORT JKQTPfilledCurveXGraph: public JKQTPxyGraph {
    ...
    public:
        ...
        GET_SET_MACRO(double, baseline)
        GET_SET_MACRO(bool, drawLine)
        GET_SET_MACRO(Qt::BrushStyle, fillStyle)
...
class LIB_EXPORT JKQTPboxplotVerticalGraph: public JKQTPgraph {
    ...
    public:
        ...
        GET_SET_MACRO(int, posColumn)
        GET_SET_MACRO(int, medianColumn)
        GET_SET_MACRO(int, meanColumn)
        GET_SET_MACRO(int, minColumn)
        GET_SET_MACRO(int, maxColumn)
        GET_SET_MACRO(int, percentile25Column)
        GET_SET_MACRO(int, percentile75Column)
        GET_SET_MACRO(QColor, color)
        GET_SET_MACRO(QColor, fillColor)
        GET_SET_MACRO(Qt::PenStyle, whiskerStyle)
        GET_SET_MACRO(Qt::BrushStyle, fillStyle)
        GET_SET_MACRO(double, lineWidth)
        GET_SET_MACRO(double, boxWidth)

        GET_SET_MACRO(JKQTPgraphSymbols, meanSymbol)
        GET_SET_MACRO(double, meanSymbolWidth)
        GET_SET_MACRO(double, meanSymbolSize)
...
class LIB_EXPORT JKQTPboxplotVerticalElement: public JKQTPgraph {
    ...
    public:
        ...
        GET_SET_MACRO(double, pos)
        GET_SET_MACRO_I(double, median, drawMedian=true)
        GET_SET_MACRO_I(double, mean, drawMean=true)
        GET_SET_MACRO_I(double, min, drawMinMax=true)
        GET_SET_MACRO_I(double, max, drawMinMax=true)
        GET_SET_MACRO(double, percentile25)
        GET_SET_MACRO(double, percentile75)
        GET_SET_MACRO(QColor, color)
        GET_SET_MACRO(QColor, fillColor)
        GET_SET_MACRO(Qt::PenStyle, whiskerStyle)
        GET_SET_MACRO(double, lineWidth)
        ...
        GET_SET_MACRO(double, meanSymbolWidth)
        GET_SET_MACRO(double, meanSymbolSize)
        GET_SET_MACRO(bool, drawMean)
        GET_SET_MACRO(bool, drawMedian)
        GET_SET_MACRO(bool, drawMinMax)
...
class LIB_EXPORT JKQTPxFunctionLineGraph: public JKQTPgraph {
    ...
    public:
        ...
        GET_SET_MACRO(unsigned int, minSamples)
        GET_SET_MACRO(unsigned int, maxRefinementDegree)
        GET_SET_MACRO(double, slopeTolerance)
        GET_SET_MACRO(double, minPixelPerSample)
        GET_SET_MACRO(bool, plotRefinement)
        GET_SET_MACRO(bool, displaySamplePoints)
        GET_SET_MACRO(bool, drawErrorPolygons)
        GET_SET_MACRO(bool, drawErrorLines)
        ...
        GET_SET_MACRO(Qt::BrushStyle, errorFillStyle)
        GET_SET_MACRO(Qt::PenStyle, errorStyle)
        GET_SET_MACRO(double, errorLineWidth)
...
class LIB_EXPORT JKQTPstepHorizontalGraph: public JKQTPxyGraph {
    ...
    public:
        ...
        GET_SET_MACRO(double, lineWidth)
        GET_SET_MACRO(bool, drawLine)
        GET_SET_MACRO(bool, fillCurve)
        GET_SET_MACRO(bool, valuesCentered)
    protected:
        /** \brief color of the graph */
        QColor color;
        /** \brief color of the graph fill */
...
class LIB_EXPORT JKQTPbarHorizontalGraph: public JKQTPxyGraph, public JKQTPxyGraphErrors {
    ...
    public:
        ...
        GET_SET_MACRO(Qt::PenStyle, style)
        GET_SET_MACRO(double, lineWidth)
        GET_SET_MACRO(double, shift)
        GET_SET_MACRO(double, width)
        GET_SET_MACRO(double, baseline)
    protected:
        /** \brief color of the graph */
        QColor color;
...
class LIB_EXPORT JKQTPhorizontalRange: public JKQTPgraph {
    ...
    public:
        ...
        GET_SET_MACRO(Qt::PenStyle, style)
        GET_SET_MACRO(double, lineWidth)
        GET_SET_MACRO(QColor, centerColor)
        GET_SET_MACRO(Qt::PenStyle, centerStyle)
        GET_SET_MACRO(double, centerLineWidth)
        GET_SET_MACRO(double, rangeMin)
        GET_SET_MACRO(double, rangeMax)
        GET_SET_MACRO(double, sizeMin)
        GET_SET_MACRO(double, sizeMax)
        GET_SET_MACRO(bool, unlimitedSizeMin)
        GET_SET_MACRO(bool, unlimitedSizeMax)

        GET_SET_MACRO(double, rangeCenter)
        GET_SET_MACRO(bool, plotCenterLine)
        GET_SET_MACRO(bool, invertedRange)
        GET_SET_MACRO(bool, plotRange)
        GET_SET_MACRO(bool, fillRange)
        GET_SET_MACRO(bool, plotRangeLines)
    protected:
