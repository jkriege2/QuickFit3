...
#include <typeinfo>
#define QColor2String(color) QString(rgbtostring((color).red(), (color).green(), (color).blue(), (color).alpha()).c_str())
...
double JKQTmathText::MTfracNode::draw(QPainter& painter, double x, double y, JKQTmathText::MTenvironment currentEv) {
    ...
    double xw=fm.boundingRect("x").width();
    double lw=mmax(0,ceil(currentEv.fontSize/16.0));//fm.lineWidth();
    ...
    double width=mmax(width1, width2);
        ...
        if (dynamic_cast<MTsuperscriptNode*>(nodes[i])) {
            ...
            if (subsupOperations.contains(s)) {
                ...
                if (subn && supn) { // is this subscript and superscript?
                    ...
                    //double d2=oh2-bh2;
                    //double d3=oh3-bh3;
                    double w=mmax(mmax(w1, w2), w3)+fm.width(" ");
            ...
            if (smb) {
                ...
                if (subsupOperations.contains(s)) {
                    ...
                    if (subn && supn) { // is this subscript and superscript?
                        ...
                        doDraw=false;
                        xnew=mmax(mmax(xn1, xn2), xn3)+fm.width(" ");
