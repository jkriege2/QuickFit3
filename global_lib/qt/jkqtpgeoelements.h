...
class LIB_EXPORT JKQTPgeoLine: public JKQTPgeoBaseLine {
    ...
    public:
        ...
        GET_SET_MACRO(double, x1)
        GET_SET_MACRO(double, y1)
        GET_SET_MACRO(double, x2)
        GET_SET_MACRO(double, y2)
    protected:
        double x1, y1, x2, y2;
};
...
class LIB_EXPORT JKQTPgeoInfiniteLine: public JKQTPgeoBaseLine {
    ...
    public:
        ...
        GET_SET_MACRO(double, x)
        GET_SET_MACRO(double, y)
        GET_SET_MACRO(double, dx)
        GET_SET_MACRO(double, dy)
        GET_SET_MACRO(bool, two_sided)
    protected:
        double x, y, dx, dy;
...
class LIB_EXPORT JKQTPgeoLines: public JKQTPgeoBaseLine {
    ...
    public:
        ...
        GET_SET_MACRO(QVector<QPointF>, points)
...
class LIB_EXPORT JKQTPgeoEllipse: public JKQTPgeoRectangle {
    ...
    public:
        ...
        GET_SET_MACRO(unsigned int, controlPoints)
    protected:
...
class LIB_EXPORT JKQTPgeoArc: public JKQTPgeoBaseLine {
    ...
    public:
        ...
        GET_SET_MACRO(unsigned int, controlPoints)
        GET_SET_MACRO(double, angleStart)
        GET_SET_MACRO(double, angleStop)
        GET_SET_MACRO(double, x)
        GET_SET_MACRO(double, y)
        GET_SET_MACRO(double, width)
        GET_SET_MACRO(double, height)
