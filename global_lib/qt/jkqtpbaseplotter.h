...
class LIB_EXPORT JKQtBasePlotter: public QObject {
    ...
    protected:
        ...
        SET_MACRO(double, fontSizeMultiplier)
        SET_MACRO(double, lineWidthMultiplier)
        GET_SET_MACRO(double, printMagnification)
        GET_SET_MACRO(double, paintMagnification)
    ...
    public slots:
        ...
        *          The image format is extracted from the file extension (jpeg, tiff, png, pdf, ...) */
         ...
         */
        void saveData(QString filename=QString(""), QString format=QString(""));
    ...
    public:
        ...
        GET_SET_MACRO(bool, emitPlotSignals)

        GET_MACRO(int, plotBorderTop)
        GET_MACRO(int, plotBorderLeft)
        GET_MACRO(int, plotBorderBottom)
        GET_MACRO(int, plotBorderRight)

        GET_MACRO(bool, maintainAspectRatio)
        GET_SET_MACRO_I(double, aspectRatio, update_plot())

        GET_MACRO(bool, maintainAxisAspectRatio)
        GET_SET_MACRO_I(double, axisAspectRatio, update_plot())

        GET_SET_MACRO_I(bool, useAntiAliasingForSystem, update_plot())
        GET_SET_MACRO_I(bool, useAntiAliasingForGraphs, update_plot())

        GET_SET_MACRO_I(QColor, graphColor, update_plot())
        GET_SET_MACRO_I(double, graphWidth, update_plot())

        GET_SET_MACRO_I(QColor, backgroundColor, update_plot())
        GET_SET_MACRO_I(QColor, exportBackgroundColor, update_plot())
        GET_SET_MACRO_I(QColor, plotBackgroundColor, update_plot())

        GET_SET_MACRO_I(QString, keyFont, update_plot())
        GET_SET_MACRO_I(double, keyFontSize, update_plot())
        GET_SET_MACRO_I(double, key_item_width, update_plot())
        GET_SET_MACRO_I(double, key_item_height, update_plot())
        GET_SET_MACRO_I(double, keyYSeparation, update_plot())
        GET_SET_MACRO_I(double, key_line_length, update_plot())
        GET_SET_MACRO_I(double, keyXMargin, update_plot())
        GET_SET_MACRO_I(double, keyYMargin, update_plot())
        GET_SET_MACRO_I(double, keyXSeparation, update_plot())

        GET_SET_MACRO_I(double, keyXOffset, update_plot())
        GET_SET_MACRO_I(double, keyYOffset, update_plot())
        GET_SET_MACRO_I(bool, showKey, update_plot())
        GET_SET_MACRO_I(bool, showKeyFrame, update_plot())
        GET_SET_MACRO_I(QColor, keyFrameColor, update_plot())
        GET_SET_MACRO_I(QColor, keyBackgroundColor, update_plot())
        GET_SET_MACRO_I(double, keyFrameWidth, update_plot())
        GET_SET_MACRO_I(bool, keyAutosize, update_plot())
        GET_SET_MACRO_I(JKQTPkeyPosition, keyPosition, update_plot())
        GET_SET_MACRO_I(JKQTPkeyLayout, keyLayout, update_plot())

        GET_SET_MACRO_I(double, plotLabelFontSize, update_plot())
        GET_SET_MACRO_I(QString, plotLabelFontname, update_plot())
        GET_SET_MACRO_I(QString, plotLabel, update_plot())

        GET_SET_MACRO(bool, gridPrinting)
        GET_SET_MACRO(size_t, gridPrintingCurrentX)
        GET_SET_MACRO(size_t, gridPrintingCurrentY)
        GET_SET_MACRO(QString, currentSaveDirectory)
        GET_SET_MACRO(QString, currentFileFormat)
        GET_SET_MACRO(QString, CSVdecimalSeparator)
        GET_SET_MACRO(QString, CSVcommentInitializer)

        GET_MACRO(int, iplotBorderTop)
        GET_MACRO(int, iplotBorderLeft)
        GET_MACRO(int, iplotBorderBottom)
        GET_MACRO(int, iplotBorderRight)
        ...
        GET_MACRO(QAction*, actSavePlot)
        GET_MACRO(QAction*, actSaveData)
        GET_MACRO(QAction*, actCopyData)
        GET_MACRO(QAction*, actCopyPixelImage)
        GET_MACRO(QAction*, actCopyMatlab)
        GET_MACRO(QAction*, actSavePDF)
#if (QT_VERSION < QT_VERSION_CHECK(5, 0, 0))
        GET_MACRO(QAction*, actSavePS)
#endif
        GET_MACRO(QAction*, actSavePix)
        GET_MACRO(QAction*, actSaveSVG)
        GET_MACRO(QAction*, actPrint)
        GET_MACRO(QAction*, actSaveCSV)
        GET_MACRO(QAction*, actZoomAll)
        GET_MACRO(QAction*, actZoomIn)
        GET_MACRO(QAction*, actZoomOut)
        GET_MACRO(QAction*, actShowPlotData)
        GET_MACRO(AdditionalActionsMap, lstAdditionalPlotterActions)
        ...
        GET_MACRO(bool, masterSynchronizeWidth)
        GET_MACRO(bool, masterSynchronizeHeight)
        SET_MACRO(QColor, def_backgroundColor)
        SET_MACRO(QColor, def_plotBackgroundColor)

        GET_SET_MACRO(double, fontSizePrintMultiplier)
        GET_SET_MACRO(double, lineWidthPrintMultiplier)
        GET_MACRO(double, fontSizeMultiplier)
        GET_MACRO(double, lineWidthMultiplier)
