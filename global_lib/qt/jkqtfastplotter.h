...
class LIB_EXPORT JKQTFastPlotter : public JKQTFASTPLOTTER_BASEWIDGET {
    ...
    public:
        ...
        GET_SET_MACRO_I(QPen, dragShapePen, update())
        GET_SET_MACRO_I(bool, dragLine, update())

        GET_SET_MACRO_I(int, plotBorderLeft, update_plot())
        GET_SET_MACRO_I(int, plotBorderBottom, update_plot())
        GET_SET_MACRO_I(int, plotBorderRight, update_plot())
        GET_SET_MACRO_I(int, plotBorderTop, update_plot())
        GET_MACRO(int, plotWidth)
        GET_MACRO(int, plotHeight)
        GET_SET_MACRO(bool, doDrawing)
        GET_MACRO(int, internalPlotBorderLeft)
        GET_MACRO(int, internalPlotBorderBottom)
        GET_MACRO(int, internalPlotBorderRight)
        GET_MACRO(int, internalPlotBorderTop)
        GET_MACRO(double, xMin)
        GET_MACRO(double, xMax)
        GET_MACRO(double, yMin)
        GET_MACRO(double, yMax)
        GET_MACRO(bool, xAxisLog)
        GET_MACRO(bool, yAxisLog)

        GET_SET_MACRO_I(QColor, backgroundColor, update_plot())
        GET_SET_MACRO_I(QColor, plotBackgroundColor, update_plot())
        GET_SET_MACRO_I(bool, drawGrid, update_plot())
        GET_SET_MACRO_I(QColor, gridColor, update_plot())
        GET_SET_MACRO_I(Qt::PenStyle, gridStyle, update_plot())
        GET_SET_MACRO_I(double, gridWidth, update_plot())
        GET_SET_MACRO_I(double, labelFontSize, update_plot())
        GET_SET_MACRO_I(QString, labelFontName, update_plot())
        GET_SET_MACRO_I(double, tickFontSize, update_plot())
        GET_SET_MACRO_I(QString, tickFontName, update_plot())
        GET_SET_MACRO_I(double, tickLength, update_plot())
        GET_SET_MACRO_I(bool, drawSystemBox, update_plot())
        GET_SET_MACRO_I(bool, drawZeroAxes, update_plot())
        GET_SET_MACRO_I(QColor, systemColor, update_plot())
        GET_SET_MACRO_I(double, systemWidth, update_plot())
        GET_SET_MACRO_I(double, xZeroTick, update_plot())
        GET_SET_MACRO_I(double, yZeroTick, update_plot())
        GET_SET_MACRO_I(double, xTickDistance, update_plot())
        GET_SET_MACRO_I(double, yTickDistance, update_plot())
        GET_SET_MACRO_I(QString, xAxisLabel, update_plot())
        GET_SET_MACRO_I(QString, yAxisLabel, update_plot())
        GET_SET_MACRO_I(double, aspectRatio, update_plot())
        GET_SET_MACRO_I(bool, maintainAspectRatio, update_plot())
        GET_SET_MACRO_I(bool, xAxisLabelVisible, update_plot())
        GET_SET_MACRO_I(bool, yAxisLabelVisible, update_plot())
        GET_SET_MACRO_I(JKQTFastPlotter*, synchronizeX, update_plot())
        GET_SET_MACRO_I(JKQTFastPlotter*, synchronizeY, update_plot())
...
class LIB_EXPORT JKQTFPLinePlot: public JKQTFPPlot {
    ...
    public:
        ...
        GET_MACRO(double*, x)
        GET_MACRO(double*, y)
        GET_MACRO(double*, yerr)
        GET_MACRO(QVector<double>*, xv)
        GET_MACRO(QVector<double>*, yv)
        GET_MACRO(QVector<double>*, yerrv)
        GET_MACRO(DataType, datatype)
        GET_SET_MACRO_I(QColor, color, replot())
        GET_SET_MACRO_I(Qt::PenStyle, style, replot())
        GET_SET_MACRO_I(double, width, replot())
        GET_SET_MACRO_I(QColor, errorColor, replot())
        GET_SET_MACRO_I(Qt::PenStyle, errorStyle, replot())
        GET_SET_MACRO_I(double, errorWidth, replot())
};
...
class LIB_EXPORT JKQTFPVCrossPlot: public JKQTFPLinePlot {
    ...
    public:
        ...
        GET_SET_MACRO_I(double, crossWidth, replot())
    protected:
...
class LIB_EXPORT JKQTFPXRangePlot: public JKQTFPPlot {
    ...
    public:
        ...
        GET_SET_MACRO_I(QColor, color, replot())
        GET_SET_MACRO_I(QColor, fillColor, replot())
        GET_SET_MACRO_I(Qt::BrushStyle, fillStyle, replot())
        GET_SET_MACRO_I(Qt::PenStyle, style, replot())
        GET_SET_MACRO_I(double, width, replot())
        GET_MACRO(double, xmin)
        GET_MACRO(double, xmax)
        GET_MACRO(double, centerline)
        GET_SET_MACRO_I(bool, showCenterline, replot())
    public slots:
...
class LIB_EXPORT JKQTFPQImagePlot: public JKQTFPPlot {
    ...
    public:
        ...
        GET_SET_MACRO_I(QImage*, image, replot())
        GET_SET_MACRO_I(double, xmin, replot())
        GET_SET_MACRO_I(double, xmax, replot())
        GET_SET_MACRO_I(double, ymin, replot())
        GET_SET_MACRO_I(double, ymax, replot())
};
...
class LIB_EXPORT JKQTFPimagePlot: public JKQTFPPlot {
    ...
    public:
        ...
        GET_SET_MACRO_I(void*, image, replot())
        GET_SET_MACRO_I(JKQTFPImageFormat, imageFormat, replot())
        GET_SET_MACRO_I(unsigned int, width, replot())
        GET_SET_MACRO_I(unsigned int, height, replot())
        GET_SET_MACRO_I(double, xmin, replot())
        GET_SET_MACRO_I(double, xmax, replot())
        GET_SET_MACRO_I(double, ymin, replot())
        GET_SET_MACRO_I(double, ymax, replot())
        GET_SET_MACRO_I(bool, drawColorBar, replot())
        GET_SET_MACRO_I(int, colorBarWidth, replot())
        GET_MACRO(int, rotation)
        GET_MACRO(JKQTFPColorPalette, palette)
        GET_MACRO(double, colorMin)
        GET_MACRO(double, colorMax)
...
class LIB_EXPORT JKQTFPRGBImageOverlayPlot: public JKQTFPPlot {
    ...
    public:
        ...
        GET_SET_MACRO_TWO_I(imageRed, void*, imageRed, JKQTFPImageFormat, imageFormatRed, replot())
        GET_SET_MACRO_TWO_I(imageGreen, void*, imageGreen, JKQTFPImageFormat, imageFormatGreen, replot())
        GET_SET_MACRO_TWO_I(imageBlue, void*, imageBlue, JKQTFPImageFormat, imageFormatBlue, replot())
        GET_SET_MACRO_I(unsigned int, width, replot())
        GET_SET_MACRO_I(unsigned int, height, replot())
        GET_SET_MACRO_I(double, xmin, replot())
        GET_SET_MACRO_I(double, xmax, replot())
        ...
        GET_SET_MACRO_I(double, ymax, replot())
        GET_MACRO(int, rotation)
        GET_MACRO(double, colorMinRed)
        GET_MACRO(double, colorMaxRed)
        GET_MACRO(double, colorMinGreen)
        GET_MACRO(double, colorMaxGreen)
        GET_MACRO(double, colorMinBlue)
        GET_MACRO(double, colorMaxBlue)
...
class LIB_EXPORT JKQTFPimageOverlayPlot: public JKQTFPPlot {
    ...
    public:
        ...
        GET_MACRO(bool*, image)
        GET_MACRO(int, rotation)
        GET_MACRO(unsigned int, width)
        GET_MACRO(unsigned int, height)
        GET_SET_MACRO_I(double, xmin, replot())
        GET_SET_MACRO_I(double, xmax, replot())
        GET_SET_MACRO_I(double, ymin, replot())
        GET_SET_MACRO_I(double, ymax, replot())
        GET_SET_MACRO_I(bool, showAsSymbols, replot())
        GET_MACRO(QColor, color)
    public slots:
        inline void set_rotation(int rotation) {
            if (this->rotation!=rotation) {
                this->rotation=(JKQTFPColorPalette)rotation;
...
class LIB_EXPORT JKQTFPQScaleBarXPlot: public JKQTFPPlot {
    ...
    public:
        ...
        GET_SET_MACRO_I(double, width, replot())
        GET_SET_MACRO_I(double, lineWidth, replot())
        GET_SET_MACRO_I(QColor, color, replot())
        GET_SET_MACRO_I(QString, label, replot())
        GET_SET_MACRO_I(QFont, font, replot())
        GET_SET_MACRO_I(Position, position, replot())
    public slots:
