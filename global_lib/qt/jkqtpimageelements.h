...
class LIB_EXPORT JKQTPImageBase: public JKQTPgraph {
    ...
    public:
        ...
        GET_SET_MACRO(double, x)
        GET_SET_MACRO(double, y)
        GET_SET_MACRO(double, width)
        GET_SET_MACRO(double, height)
...
class LIB_EXPORT JKQTPMathImageBase: public JKQTPImageBase {
    ...
    public:
        ...
        GET_SET_MACRO(uint32_t, Nx)
        GET_SET_MACRO(uint32_t, Ny)
        GET_SET_MACRO(void*, data)
        GET_SET_MACRO(DataType, datatype)
        GET_SET_MACRO(void*, dataModifier)
        GET_SET_MACRO(DataType, datatypeModifier)
        GET_SET_MACRO(ModifierMode, modifierMode)
...
class LIB_EXPORT JKQTPMathImage: public JKQTPMathImageBase {
    ...
    public:
        ...
        GET_SET_MACRO(JKQTPMathImageColorPalette, palette)
        GET_SET_MACRO(JKQTPMathImageColorRangeFailAction, rangeMinFailAction)
        GET_SET_MACRO(JKQTPMathImageColorRangeFailAction, rangeMaxFailAction)
        GET_SET_MACRO(QColor, rangeMinFailColor)
        GET_SET_MACRO(QColor, rangeMaxFailColor)
        GET_SET_MACRO(QColor, nanColor)
        GET_SET_MACRO(QColor, infColor)
        GET_SET_MACRO(bool, showColorBar)
        GET_SET_MACRO(int, colorBarWidth)
        GET_SET_MACRO(int, colorBarModifiedWidth)
        GET_SET_MACRO(int, colorBarOffset)
        GET_SET_MACRO(double, colorBarRelativeHeight)
        GET_SET_MACRO(double, imageMin)
        GET_SET_MACRO(double, imageMax)
        GET_SET_MACRO(bool, autoImageRange)
        GET_SET_MACRO(QString, imageName)
        GET_SET_MACRO(QString, imageNameFontName)
        GET_SET_MACRO(double, imageNameFontSize)
        GET_MACRO(JKQTPverticalIndependentAxis*, colorBarRightAxis)
        GET_MACRO(JKQTPhorizontalIndependentAxis*, colorBarTopAxis)
        GET_MACRO(JKQTPverticalIndependentAxis*, modifierColorBarTopAxis)
        GET_MACRO(JKQTPhorizontalIndependentAxis*, modifierColorBarRightAxis )
        GET_SET_MACRO(bool, colorBarTopVisible)
        GET_SET_MACRO(bool, colorBarRightVisible)
        GET_SET_MACRO(bool, autoModifierRange)
        GET_SET_MACRO(double, modifierMin)
        GET_SET_MACRO(double, modifierMax)
...
class LIB_EXPORT JKQTPRGBMathImage: public JKQTPMathImageBase {
    ...
    public:
        ...
        GET_SET_MACRO(void*, dataG)
        GET_SET_MACRO(DataType, datatypeG)
        GET_SET_MACRO(void*, dataB)
        GET_SET_MACRO(DataType, datatypeB)
        GET_SET_MACRO(bool, showColorBar)
        GET_SET_MACRO(int, colorBarWidth)
        GET_SET_MACRO(int, colorBarOffset)
        GET_SET_MACRO(double, colorBarRelativeHeight)
        GET_SET_MACRO(double, imageMin)
        GET_SET_MACRO(double, imageMax)
        GET_SET_MACRO(double, imageMinG)
        GET_SET_MACRO(double, imageMaxG)
        GET_SET_MACRO(double, imageMinB)
        GET_SET_MACRO(double, imageMaxB)
        GET_SET_MACRO(bool, autoImageRange)
        GET_SET_MACRO(QString, imageName)
        GET_SET_MACRO(QString, imageNameG)
        GET_SET_MACRO(QString, imageNameB)
        GET_SET_MACRO(QString, imageNameFontName)
        GET_SET_MACRO(double, imageNameFontSize)
        GET_MACRO(JKQTPverticalIndependentAxis*, colorBarRightAxis)
        GET_MACRO(JKQTPhorizontalIndependentAxis*, colorBarTopAxis)
        GET_MACRO(JKQTPverticalIndependentAxis*, colorBarRightAxisG)
        GET_MACRO(JKQTPhorizontalIndependentAxis*, colorBarTopAxisG)
        GET_MACRO(JKQTPverticalIndependentAxis*, colorBarRightAxisB)
        GET_MACRO(JKQTPhorizontalIndependentAxis*, colorBarTopAxisB)
        GET_SET_MACRO(bool, colorBarTopVisible)
        GET_SET_MACRO(bool, colorBarRightVisible)
        GET_SET_MACRO(bool, colorbarsSideBySide)
        GET_SET_MACRO(JKQTPRGBMathImageRGBMode, rgbMode)
...
class LIB_EXPORT JKQTPColumnMathImage: public JKQTPMathImage {
    ...
    public:
        ...
        GET_SET_MACRO(int, imageColumn)
        GET_SET_MACRO(int, modifierColumn)
...
class LIB_EXPORT JKQTPColumnRGBMathImage: public JKQTPRGBMathImage {
    ...
    public:
        ...
        GET_SET_MACRO(int, imageRColumn)
        GET_SET_MACRO(int, imageGColumn)
        GET_SET_MACRO(int, imageBColumn)
        GET_SET_MACRO(int, modifierColumn)
        /** \copydoc JKQTPgraph::usesColumn() */
        virtual bool usesColumn(int c);
...
class LIB_EXPORT JKQTPOverlayImage: public JKQTPImageBase {
    ...
    public:
        ...
        GET_SET_MACRO(QColor, trueColor)
        GET_SET_MACRO(QColor, falseColor)
        GET_SET_MACRO(uint32_t, Nx)
        GET_SET_MACRO(uint32_t, Ny)
        GET_SET_MACRO(bool*, data)
...
class LIB_EXPORT JKQTPOverlayImageEnhanced: public JKQTPOverlayImage {
    ...
    public:
        ...
        GET_SET_MACRO(bool, drawAsRectangles)
        GET_SET_MACRO(bool, rectanglesAsImageOverlay)
        GET_SET_MACRO(double, symbolSizeFactor)
...
class LIB_EXPORT JKQTPContour: public JKQTPMathImage {
    ...
    public:
        ...
        GET_SET_MACRO(QColor, lineColor)
        GET_SET_MACRO(Qt::PenStyle, style)
        GET_SET_MACRO(double, lineWidth)
        GET_SET_MACRO(bool, ignoreOnPlane)
        GET_SET_MACRO(int, numberOfLevels)
        GET_SET_MACRO(bool, colorFromPalette)
        GET_SET_MACRO(QList<double>, contourLevels)
        GET_SET_MACRO(bool, relativeLevels)
