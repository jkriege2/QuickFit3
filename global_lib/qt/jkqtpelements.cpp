...
{
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPPeakStreamGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPxyLineGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPimpulsesHorizontalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
void JKQTPimpulsesHorizontalGraph::drawKeyMarker(JKQTPEnhancedPainter& painter, QRectF& rect) {
    ...
    p.setStyle(Qt::SolidLine);
    p.setCapStyle(Qt::FlatCap);
    p.setWidthF(qMax(JKQTPLOTTER_ABS_MIN_LINEWIDTH,mmin(parent->pt2px(painter, mmax(1, lineWidth)), rect.height()/2.0)*parent->get_lineWidthMultiplier()));
    painter.setPen(p);
    int y=rect.top()+rect.height()/2.0;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPimpulsesVerticalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPfilledCurveXGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPfilledCurveYGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPboxplotVerticalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPboxplotHorizontalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPboxplotVerticalElement::draw");
#endif
    if (parent==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPboxplotHorizontalElement::draw");
#endif
    if (parent==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaat(QString("JKQTPxFunctionLineGraph[%1]::createPlotData()").arg(title));
#endif
    clearData();
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPxFunctionLineGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPyFunctionLineGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPstepHorizontalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPstepVerticalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPbarHorizontalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPbarVerticalGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPhorizontalRange::draw");
#endif
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPverticalRange::draw");
#endif
...
{
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot("JKQTPxyParametrizedScatterGraph::draw");
#endif
    if (parent==NULL) return;
    JKQTPdatastore* datastore=parent->getDatastore();
    if (datastore==NULL) return;
