...
class LIB_EXPORT JKQTmathText : public QObject {
    ...
    public:
        ...
        */
        ...
        GET_SET_MACRO(QColor, fontColor)
        GET_SET_MACRO(double, fontSize)
        GET_SET_MACRO(QString, fontRoman)
        GET_SET_MACRO(QString, fontSans)
        GET_SET_MACRO(QString, fontTypewriter)
        GET_SET_MACRO(QString, fontScript)
        GET_SET_MACRO(QString, fontGreek)
        GET_SET_MACRO(QString, fontSymbol)
        GET_SET_MACRO(QString, fontBraces)
        GET_SET_MACRO(QString, fontIntegrals)
        GET_SET_MACRO(QString, fontCaligraphic)
        GET_SET_MACRO(QString, fontBlackboard)
        GET_SET_MACRO(QString, fontMathRoman)
        GET_SET_MACRO(QString, fontMathSans)
        GET_SET_MACRO(QString, fontLatexPrefix)
        GET_SET_MACRO(QString, fontLatexPostfix)
        GET_SET_MACRO(MTfontEncoding, fontEncoding)
        GET_MACRO(bool, useSTIXfonts)
        GET_MACRO(bool, useXITSfonts)
        GET_SET_MACRO(double, brace_factor)
        GET_SET_MACRO(double, subsuper_size_factor)
        GET_SET_MACRO(double, italic_correction_factor)
        GET_SET_MACRO(double, operatorsubsuper_size_factor)
        GET_SET_MACRO(double, mathoperator_width_factor)
        GET_SET_MACRO(double, super_shift_factor)
        GET_SET_MACRO(double, sub_shift_factor)
        GET_SET_MACRO(double, brace_shrink_factor)
        GET_SET_MACRO(double, underbrace_factor)
        GET_SET_MACRO(double, underset_factor)
        GET_SET_MACRO(double, frac_factor)
        GET_SET_MACRO(double, frac_shift_factor)
        GET_SET_MACRO(double, brace_y_shift_factor)
        GET_SET_MACRO(double, decoration_height_factor)
        GET_SET_MACRO(bool, expensiveRendering)
        GET_SET_MACRO(bool, useUnparsed)
        GET_MACRO(QStringList, error_list)
    ...
    public:
        ...
        class MTinstruction1Node: public MTnode {
            public:
                ...
                virtual bool toHtml(QString& html, JKQTmathText::MTenvironment currentEv, JKQTmathText::MTenvironment defaultEv);
                virtual void set_drawBoxes(bool draw);
                GET_MACRO(MTnode*, child)
                GET_MACRO(QString, name)
                GET_MACRO(QStringList, parameters)
            protected:
                MTnode* child;
                QString name;
        ...
        class MTbraceNode: public MTnode {
            public:
                ...
                GET_MACRO(MTnode*, child)
                GET_MACRO(QString, openbrace)
                GET_MACRO(QString, closebrace)
                GET_MACRO(bool, showRightBrace)
            protected:
                MTnode* child;
                QString openbrace;
                QString closebrace;
        ...
        class MTfracNode: public MTnode {
            public:
                ...
                virtual bool toHtml(QString& html, JKQTmathText::MTenvironment currentEv, JKQTmathText::MTenvironment defaultEv);
                virtual void set_drawBoxes(bool draw);
                GET_MACRO(MTnode*, child1)
                GET_MACRO(MTnode*, child2)
                GET_MACRO(MTfracMode, mode)
            protected:
                MTnode* child1;
                MTnode* child2;
                MTfracMode mode;
        ...
        class MTmatrixNode: public MTnode {
            public:
                ...
                virtual double draw(QPainter& painter, double x, double y, MTenvironment currentEv);
                virtual bool toHtml(QString& html, JKQTmathText::MTenvironment currentEv, JKQTmathText::MTenvironment defaultEv);
                GET_MACRO(QVector<QVector<MTnode*> >, children)
                GET_MACRO(int, columns)
                GET_MACRO(int, lines)
            protected:
                virtual void set_drawBoxes(bool draw);
        ...
        class MTdecoratedNode: public MTnode {
            public:
                ...
                GET_MACRO(MTnode*, child)
                GET_MACRO(MTdecoration, decoration)
            protected:
                MTnode* child;
