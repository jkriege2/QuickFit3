...
class LIB_EXPORT JKQTPoverlayTwoCoordOverlay : public JKQTPoverlayOneCoordOverlay {
    ...
    public:
        ...
        GET_SET_MACRO(double, position2)
    protected:
        double position2;
};
