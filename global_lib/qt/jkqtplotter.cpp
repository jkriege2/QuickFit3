...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot(QString("JKQtPlotter::replot_overlays()"));
#endif
    if (!doDrawing) return;
    disconnect(plotter, SIGNAL(plotUpdated()), this, SLOT(update_plot()));
    disconnect(plotter, SIGNAL(overlaysUpdated()), this, SLOT(replot_overlays()));
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot(QString("JKQtPlotter::update_plot()"));
#endif
    if (!doDrawing) return;
    disconnect(plotter, SIGNAL(plotUpdated()), this, SLOT(update_plot()));
    disconnect(plotter, SIGNAL(overlaysUpdated()), this, SLOT(replot_overlays()));
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot(QString("JKQtPlotter::replot_plot()"));
#endif
    if (!doDrawing) return;
    disconnect(plotter, SIGNAL(plotUpdated()), this, SLOT(update_plot()));
    disconnect(plotter, SIGNAL(overlaysUpdated()), this, SLOT(replot_overlays()));
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot(QString("JKQtPlotter::paintEvent()"));
#endif
...
#ifdef JKQTBP_AUTOTIMER
    JKAutoOutputTimer jkaaot(QString("JKQtPlotter::resizeEvent()"));
#endif
