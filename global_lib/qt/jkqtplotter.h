...
class LIB_EXPORT JKQtPlotter: public QWidget {
    ...
    public:
        ...
        GET_SET_MACRO_I(bool, displayToolbar, updateToolbar())
        GET_SET_MACRO_I(bool, toolbarAlwaysOn, updateToolbar())
        GET_SET_MACRO(bool, displayMousePosition)
        GET_SET_MACRO(bool, displayCustomMousePosition)
        GET_SET_MACRO_I(QColor, userActionColor, update())
        GET_SET_MACRO_I(QPainter::CompositionMode, userActionCompositionMode, update())
        GET_SET_MACRO_I(MouseActionModes, mouseActionMode, updateCursor())
        ...
        */
        ...
        GET_SET_MACRO(RightMouseButtonAction, rightMouseButtonAction);

        GET_SET_MACRO(bool, zoomByMouseWheel);
