...
class LIB_EXPORT JKQTPcolumn {
  ...
  protected:
    GET_MACRO(JKQTPdatastore*, datastore)
  public:
    JKQTPcolumn() {
        datastore=NULL;
        name="";
    ...
    GET_MACRO(size_t, datastoreItem)
    GET_MACRO(unsigned long long, datastoreOffset)
};
...
class LIB_EXPORT JKQTPdatastoreItem {
  ...
  public:
    ...
    GET_MACRO(unsigned long long, rows)
    GET_MACRO(size_t, columns)
