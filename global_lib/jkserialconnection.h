...
#ifndef JKSERIALCONNECTION_H
#define JKSERIALCONNECTION_H
...
#ifdef __WINDOWS__
# include <windows.h>
# define JKSCDEFAULTPORT std::string("COM1")
#endif

#ifdef __LINUX__
# include <termios.h>
# define JKSCDEFAULTPORT std::string("/dev/ttys0")
#endif
 ...
 *  \ingroup jkserial
 */
enum JKSChandshaking {
    JKSCnoHandshaking,
    JKSCxonXoffHandshaking,
    JKSChardwareHandshakingDTRRTS,
    JKSChardwareHandshakingRTS
};
...
class JKSerialConnection
{
    public:
         ...
         */
        JKSerialConnection(std::string port=JKSCDEFAULTPORT, unsigned int baudrate=9600, JKSCdatabits databits=JKSC8databits, JKSCparity parity=JKSCnoParity, JKSCstopbits stopbits=JKSConeStopbit, JKSChandshaking handshaking=JKSCnoHandshaking);

        /** \brief class destructor. This also closes the connection if it is still open. */
        virtual ~JKSerialConnection();
         ...
         *
         */
        bool open(std::string port, unsigned int baudrate=9600, JKSCdatabits databits=JKSC8databits, JKSCparity parity=JKSCnoParity, JKSCstopbits stopbits=JKSConeStopbit, JKSChandshaking handshaking=JKSCnoHandshaking);
