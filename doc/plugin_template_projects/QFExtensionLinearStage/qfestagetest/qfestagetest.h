#ifndef QFESTAGETEST_H
#define QFESTAGETEST_H
...
/*!
    \defgroup qf3ext_stage_test QFExtensionLinearStage implementation
    \ingroup qf3extensionplugins
*/

/*! \brief QFExtensionLinearStage implementation
    \ingroup qf3ext_stage_test
 */
class QFEStageTest : public QObject, public QFExtensionBase, public QFExtensionLinearStage {
        Q_OBJECT
        Q_INTERFACES(QFExtension QFExtensionLinearStage)
    public:
        /** Default constructor */
        QFEStageTest(QObject* parent=NULL);
        /** Default destructor */
        virtual ~QFEStageTest();
    ...
    /////////////////////////////////////////////////////////////////////////////
        ...
        virtual QString getID() const  { return QString("stage_test"); };
        ...
        virtual QString getIconFilename() const  { /* plug in name from .qrc file */ return QString(":/stage_test/qfestagetest.png"); };
