...
/*!
    \defgroup qf3ext_cam_test QFExtensionCamera implementation
    \ingroup qf3extensionplugins
*/

/*! \brief QFExtensionCamera implementation
    \ingroup qf3ext_cam_test
 */
class QFECamTest : public QObject, public QFExtensionBase, public QFExtensionCamera {
        Q_OBJECT
        Q_INTERFACES(QFExtension QFExtensionCamera)
    public:
        /** Default constructor */
        QFECamTest(QObject* parent=NULL);
        /** Default destructor */
        virtual ~QFECamTest();
    ...
    /////////////////////////////////////////////////////////////////////////////
        ...
        virtual QString getID() const  { return QString("cam_test"); };
        ...
        virtual QString getIconFilename() const  { return QString(":/cam_test/qfecamtest.png"); };
